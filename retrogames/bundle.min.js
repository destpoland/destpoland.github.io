...
var Sentry = function(t) {
    ...
    function N(t, e) {
        return "domain" === e && "object" == typeof t && t._events ? "[Domain]" : "domainEmitter" === e ? "[DomainEmitter]" : "undefined" != typeof global && t === global ? "[Global]" : "undefined" != typeof window && t === window ? "[Window]" : "undefined" != typeof document && t === document ? "[Document]" : t instanceof Date ? "[Date] " + t : t instanceof Error ? function(t) {
            var e = {
                message: t.message,
                name: t.name,
                stack: t.stack
            ...
            return e
        }(t) : m(t) ? "[NaN]" : d(t) ? "[undefined]" : "function" == typeof t ? "[Function] " + (t.name || "<unknown-function-name>") : t
    }
    function M() {
        var t = []
          , e = [];
        return function(n, r) {
            if (t.length > 0) {
                ...
                -1 === o ? (t.push(this),
                e.push(n)) : (t.splice(o + 1),
                e.splice(o, 1 / 0, n)),
                -1 !== t.indexOf(r) && (r = function(n, r) {
    ...
    function U(t) {
        try {
            return JSON.parse(JSON.stringify(t, M()))
        } catch (t) {
    ...
    var L = function() {
        ...
        t.prototype.addEventProcessor = function(t) {
            return this.eventProcessors.push(t),
            this
        }
        ,
        ...
        t.prototype.setTag = function(t, e) {
            var n;
            return this.tags = i({}, this.tags, ((n = {})[t] = U(e),
            n)),
            this.notifyScopeListeners(),
            this
        }
        ...
        t.prototype.setExtra = function(t, e) {
            var n;
            return this.extra = i({}, this.extra, ((n = {})[t] = U(e),
            n)),
            this.notifyScopeListeners(),
            this
        }
        ...
        t.prototype.setFingerprint = function(t) {
            return this.fingerprint = U(t),
            this.notifyScopeListeners(),
            this
        }
        ,
        t.prototype.setLevel = function(t) {
            return this.level = U(t),
            this.notifyScopeListeners(),
            this
        }
        ,
        ...
        t.prototype.addBreadcrumb = function(t, e) {
            this.breadcrumbs = void 0 !== e && e >= 0 ? l(this.breadcrumbs, [U(t)]).slice(-e) : l(this.breadcrumbs, [U(t)]),
            this.notifyScopeListeners()
        }
        ,
        t.prototype.applyFingerprint = function(t) {
            ...
            this.fingerprint ? t.fingerprint = t.fingerprint.concat(this.fingerprint) : t.message && (t.fingerprint = t.fingerprint.concat(t.message)),
        ...
        t.prototype.applyToEvent = function(t, e, n) {
            return a(this, void 0, void 0, function() {
                return s(this, function(r) {
                    return this.extra && Object.keys(this.extra).length && (t.extra = i({}, this.extra, t.extra)),
                    ...
                    (!t.breadcrumbs || 0 === t.breadcrumbs.length) && this.breadcrumbs.length > 0 && (t.breadcrumbs = void 0 !== n && n >= 0 ? this.breadcrumbs.slice(-n) : this.breadcrumbs),
      ...
      , H = new (function() {
        ...
        t.prototype.log = function() {
            ...
            this.enabled && w(function() {
                P.console.log("Sentry Logger [Log]: " + t.join(" "))
            })
        }
        ,
        t.prototype.warn = function() {
            for (var t = [], e = 0; e < arguments.length; e++)
                t[e] = arguments[e];
            this.enabled && w(function() {
                P.console.warn("Sentry Logger [Warn]: " + t.join(" "))
            })
        }
        ,
        t.prototype.error = function() {
            for (var t = [], e = 0; e < arguments.length; e++)
                t[e] = arguments[e];
            this.enabled && w(function() {
                P.console.error("Sentry Logger [Error]: " + t.join(" "))
            })
        }
        ,
        t
      ...
      , q = function() {
        ...
        t.prototype.getIntegration = function(t) {
            try {
                ...
                return H.warn("Cannot retrieve integration " + t.id + " from the current Hub"),
                null
            }
        }
        ,
    ...
    function G() {
        ...
        try {
            ...
            if (!r)
                return X(n);
            if (!Y(r) || X(r).isOlderThan($)) {
                var o = X(n).getStackTop();
                z(r, new q(o.client,L.clone(o.scope)))
            }
            return X(r)
        } catch (t) {
            return X(n)
    ...
    function X(t) {
        return t && t.__SENTRY__ && t.__SENTRY__.hub ? t.__SENTRY__.hub : (t.__SENTRY__ = {},
        t.__SENTRY__.hub = new q,
        t.__SENTRY__.hub)
    }
    function z(t, e) {
    ...
    var Z = function(t) {
      ...
      , tt = function() {
        function t(t) {
            "string" == typeof t ? this.fromString(t) : this.fromComponents(t),
            this.validate()
        }
        ...
        t.prototype.validate = function() {
            ...
            try {
                for (var n = u(["protocol", "user", "host", "projectId"]), r = n.next(); !r.done; r = n.next()) {
                    var o = r.value;
                    if (!this[o])
                        throw new Z("Invalid Dsn: Missing " + o)
                }
            } catch (e) {
                t = {
                    error: e
            ...
            if ("http" !== this.protocol && "https" !== this.protocol)
                throw new Z('Invalid Dsn: Unsupported protocol "' + this.protocol + '"');
            if (this.port && m(parseInt(this.port, 10)))
                throw new Z('Invalid Dsn: Invalid port number "' + this.port + '"')
        }
        ,
        t
    }()
    ...
    function at(t) {
        var e = {};
        return function(t) {
            var e, n, r, o, i = t.defaultIntegrations && l(t.defaultIntegrations) || [], a = t.integrations, s = [];
            if (Array.isArray(a)) {
                ...
                try {
                    for (var f = u(i), h = f.next(); !h.done; h = f.next()) {
                        var d = h.value;
                        -1 === c.indexOf(st(d)) && -1 === p.indexOf(st(d)) && (s.push(d),
                        p.push(st(d)))
                    }
                } catch (t) {
                    e = {
            ...
            e[st(n)] = n,
            function(t, e) {
                if (-1 === it.indexOf(st(t))) {
                    try {
                        t.setupOnce()
                    } catch (n) {
                        H.warn("Integration " + st(t) + ': The install method is deprecated. Use "setupOnce".'),
                        t.install && t.install(e)
                    }
                    it.push(st(t)),
                    H.log("Integration installed: " + st(t))
                }
            }(n, t)
        }),
        e
    ...
    var ut, ct = function() {
        function e(t, e) {
            ...
            this.options = e,
            e.dsn && (this.dsn = new tt(e.dsn)),
            this.integrations = at(this.options)
        }
        return e.prototype.install = function() {
            if (!this.isEnabled())
                return this.installed = !1;
            var t = this.getBackend();
            return !this.installed && t.install && t.install(),
            this.installed = !0
        }
        ,
        ...
        e.prototype.captureException = function(t, e, n) {
            return a(this, void 0, void 0, function() {
                ...
                return s(this, function(o) {
                    return [2, this.buffer(a(r, void 0, void 0, function() {
                        var r;
                        return s(this, function(o) {
                            switch (o.label) {
                            case 0:
        ...
        e.prototype.captureMessage = function(t, e, n, r) {
            return a(this, void 0, void 0, function() {
                ...
                return s(this, function(i) {
                    return [2, this.buffer(a(o, void 0, void 0, function() {
                        var o;
                        return s(this, function(i) {
                            switch (i.label) {
                            case 0:
        ...
        e.prototype.addBreadcrumb = function(t, e, n) {
            ...
            if (!(s <= 0)) {
                ...
                null !== l && this.getBackend().storeBreadcrumb(l) && n && n.addBreadcrumb(l, Math.min(s, 100))
            }
        }
        ,
        ...
        e.prototype.prepareEvent = function(t, e, n) {
            return a(this, void 0, void 0, function() {
                ...
                return s(this, function(s) {
                    ...
                    p.message && (p.message = nt(p.message, 250)),
                    (f = p.exception && p.exception.values && p.exception.values[0]) && f.value && (f.value = nt(f.value, 250)),
                    (h = p.request) && h.url && (h.url = nt(h.url, 250)),
                    void 0 === p.event_id && (p.event_id = E()),
        ...
        e.prototype.processEvent = function(e, n, r, o) {
            return a(this, void 0, void 0, function() {
                ...
                return s(this, function(s) {
                    switch (s.label) {
                    case 0:
                        return this.isEnabled() ? (i = this.getOptions(),
                        a = i.beforeSend,
                        "number" == typeof (u = i.sampleRate) && Math.random() > u ? [2, {
                    ...
                    case 3:
                        void 0 === (l = s.sent()) && H.error("`beforeSend` method has to return `null` or a valid event"),
                        s.label = 4;
                    case 4:
                        return [3, 6];
                    case 5:
        ...
        e.prototype.getIntegration = function(t) {
            try {
                ...
                return H.warn("Cannot retrieve integration " + t.id + " from the current Client"),
                null
            }
        }
        ,
        ...
        return t.prototype.add = function(t) {
            return a(this, void 0, void 0, function() {
                ...
                return s(this, function(n) {
                    return -1 === this.buffer.indexOf(t) && this.buffer.push(t),
                    t.then(function() {
        ...
        function t(t) {
            this.buffer = new lt,
            this.options = t,
            this.options.dsn || H.warn("No DSN provided, backend will not do anything.")
        }
        return t.prototype.eventFromException = function(t, e) {
            return a(this, void 0, void 0, function() {
                return s(this, function(t) {
                    throw new Z("Backend has to implement `eventFromException` method")
                })
            })
        }
        ,
        t.prototype.eventFromMessage = function(t, e, n) {
            return a(this, void 0, void 0, function() {
                return s(this, function(t) {
                    throw new Z("Backend has to implement `eventFromMessage` method")
                })
            })
        }
        ,
        t.prototype.sendEvent = function(t) {
            return a(this, void 0, void 0, function() {
                return s(this, function(t) {
                    throw new Z("Backend has to implement `sendEvent` method")
                })
            })
        }
        ,
    ...
    var ft, ht = function() {
                ...
                return a(e, void 0, void 0, function() {
                    ...
                    return s(this, function(r) {
                        if (e = G().getIntegration(t)) {
                            try {
                                if (e.shouldDropEvent(n, e.previousEvent))
                                    return [2, null]
                            } catch (t) {
        ...
        t.prototype.shouldDropEvent = function(t, e) {
            return !!e && (this.isSameMessageEvent(t, e) ? (H.warn("Event dropped due to being a duplicate of previous event (same message).\nEvent: " + S(t)),
            !0) : !!this.isSameExceptionEvent(t, e) && (H.warn("Event dropped due to being a duplicate of previous event (same exception).\nEvent: " + S(t)),
            !0))
        }
        ,
        ...
        t.prototype.getFramesFromEvent = function(t) {
            var e = t.exception;
            if (!e)
                return t.stacktrace ? t.stacktrace.frames : void 0;
            try {
        ...
        return t.prototype.setupOnce = function() {
            H.warn("SDKInformation Integration is deprecated and can be safely removed. It's functionality has been merged into the SDK's core.")
        }
        ,
        t
    }(), gt = [/^Script error\.?$/, /^Javascript error: Script error\.? on line 0$/], yt = function() {
        function t(e) {
            void 0 === e && (e = {}),
            this.options = e,
            this.name = t.id
        ...
        return t.prototype.setupOnce = function() {
            ...
            B(function(n) {
                return a(e, void 0, void 0, function() {
                    var e, r, o, i, a;
                    return s(this, function(s) {
                        return (e = G()) && (r = e.getIntegration(t)) && (o = e.getClient(),
                        i = o ? o.getOptions() : {},
                        a = r.mergeOptions(i),
                        r.shouldDropEvent(n, a)) ? [2, null] : [2, n]
                    })
                })
            })
        }
        ,
        t.prototype.shouldDropEvent = function(t, e) {
            return this.isSentryError(t, e) ? (H.warn("Event dropped due to being internal Sentry Error.\nEvent: " + S(t)),
            !0) : this.isIgnoredError(t, e) ? (H.warn("Event dropped due to being matched by `ignoreErrors` option.\nEvent: " + S(t)),
            !0) : this.isBlacklistedUrl(t, e) ? (H.warn("Event dropped due to being matched by `blacklistUrls` option.\nEvent: " + S(t) + ".\nUrl: " + this.getEventFilterUrl(t)),
            !0) : !this.isWhitelistedUrl(t, e) && (H.warn("Event dropped due to not being matched by `whitelistUrls` option.\nEvent: " + S(t) + ".\nUrl: " + this.getEventFilterUrl(t)),
            !0)
        }
        ,
        ...
        t.prototype.isIgnoredError = function(t, e) {
            var n = this;
            return void 0 === e && (e = {}),
            !(!e.ignoreErrors || !e.ignoreErrors.length) && this.getPossibleEventMessages(t).some(function(t) {
        ...
        t.prototype.mergeOptions = function(t) {
            return void 0 === t && (t = {}),
            {
                ...
                ignoreErrors: l(this.options.ignoreErrors || [], t.ignoreErrors || [], gt),
        ...
        t.prototype.isMatchingPattern = function(t, e) {
            return n = e,
            "[object RegExp]" === Object.prototype.toString.call(n) ? e.test(t) : "string" == typeof e && ot(t, e);
            var n
        }
        ,
        t.prototype.getPossibleEventMessages = function(t) {
            ...
            try {
                ...
                return H.error("Cannot extract message for event " + S(t)),
                []
            }
        }
        ,
        t.prototype.getEventFilterUrl = function(t) {
            try {
                ...
                return H.error("Cannot extract url for event " + S(t)),
                null
            }
        }
        ,
        t.id = "InboundFilters",
        t
    }(), mt = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {};
    function bt(t) {
    ...
    xt.isRegExp,
    xt.isNaN;
    var _t = Et(function(t, e) {
        function n() {
            return "[object process]" === Object.prototype.toString.call("undefined" != typeof process ? process : 0)
        }
        function r() {
            return n() ? mt : "undefined" != typeof window ? window : "undefined" != typeof self ? self : {}
        }
        function o(t) {
            var e, n, r, o, i, a = [];
            if (!t || !t.tagName)
        ...
        e.htmlTreeAsString = function(t) {
            for (var e, n = t, r = [], i = 0, a = 0, s = " > ".length; n && i++ < 5 && !("html" === (e = o(n)) || i > 1 && a + r.length * s + e.length >= 80); )
                r.push(e),
                a += e.length,
                n = n.parentNode;
        ...
        e.consoleSandbox = function(t) {
            ...
            var n = e.console
              , o = {};
            ["debug", "info", "warn", "error", "log"].forEach(function(t) {
                t in e.console && n[t].__sentry__ && (o[t] = n[t].__sentry_wrapped__,
                n[t] = n[t].__sentry_original__)
            });
            var i = t();
    ...
    _t.uuid4,
    _t.htmlTreeAsString,
    _t.htmlElementAsString,
    _t.parseUrl,
    _t.getEventDescription,
    _t.consoleSandbox;
    var St = Et(function(t, e) {
        Object.defineProperty(e, "__esModule", {
            value: !0
        });
        var n = _t.getGlobalObject()
          , r = new (function() {
            function t() {
                this.enabled = !1
            }
            ...
            t.prototype.log = function() {
                for (var t = [], e = 0; e < arguments.length; e++)
                    t[e] = arguments[e];
                this.enabled && _t.consoleSandbox(function() {
                    n.console.log("Sentry Logger [Log]: " + t.join(" "))
                })
            }
            ,
            t.prototype.warn = function() {
                for (var t = [], e = 0; e < arguments.length; e++)
                    t[e] = arguments[e];
                this.enabled && _t.consoleSandbox(function() {
                    n.console.warn("Sentry Logger [Warn]: " + t.join(" "))
                })
            }
            ,
            t.prototype.error = function() {
                for (var t = [], e = 0; e < arguments.length; e++)
                    t[e] = arguments[e];
                this.enabled && _t.consoleSandbox(function() {
                    n.console.error("Sentry Logger [Error]: " + t.join(" "))
                })
            }
            ,
            t
      ...
      , kt = function() {
        ...
        return t.prototype.setupOnce = function() {
            ...
            B(function(n, r) {
                return a(e, void 0, void 0, function() {
                    return s(this, function(e) {
                        return G().getIntegration(t) && r && r.originalException ? [2, this.enhanceEventWithErrorData(n, r.originalException)] : [2, n]
                    })
                })
            })
        }
        ...
        t.prototype.extractErrorData = function(t) {
            ...
            try {
                ...
                if (a.length) {
                    var s = {};
                    try {
                        for (var c = u(a), l = c.next(); !l.done; l = c.next()) {
                            var f = l.value
                              , h = t[f];
                            p(h) && (h = h.name || h.constructor.name),
                            s[f] = h
                        }
                    } catch (t) {
                        e = {
                ...
                return wt.error("Unable to extract extra data from the Error object:", t),
                null
            }
        }
        ,
        ...
        return t.prototype.setupOnce = function() {
            ...
            B(function(n, r) {
                return a(e, void 0, void 0, function() {
                    var e;
                    return s(this, function(o) {
                        return (e = G().getIntegration(t)) && (e.options.debugger,
                        e.options.stringify ? (console.log(JSON.stringify(n, null, 2)),
    ...
    function Rt(t, e) {
        ...
        r = jt.exec(n),
        r ? r.slice(1) : [])[2];
        return e && o.substr(-1 * e.length) === e && (o = o.substr(0, o.length - e.length)),
        o
    }
    var Ft = function() {
        function t(e) {
                ...
                return a(n, void 0, void 0, function() {
                    ...
                    return s(this, function(n) {
                        return t.filename && t.filename.startsWith("/") && (e = this.root ? function(t, e) {
                            t = Tt(t).substr(1),
                            e = Tt(e).substr(1);
                            for (var n = It(t.split("/")), r = It(e.split("/")), o = Math.min(n.length, r.length), i = o, a = 0; a < o; a++)
                                if (n[a] !== r[a]) {
                                    i = a;
                                    break
                                }
                        ...
                        }(this.root, t.filename) : Rt(t.filename),
                        t.filename = "app:///" + e),
                        [2, t]
                    })
                })
        ...
        t.prototype.process = function(t) {
            return a(this, void 0, void 0, function() {
                ...
                return s(this, function(s) {
                    switch (s.label) {
                    case 0:
                        if (!(e = this.getFramesFromEvent(t)))
                            return [3, 4];
                        for (r in n = [],
                        e)
                            n.push(r);
    ...
    function Ut(t, e, n, r, o, i) {
        return Mt((a = Mt(Mt(e, t), Mt(r, i))) << (s = o) | a >>> 32 - s, n);
        var a, s
    }
    function Lt(t, e, n, r, o, i, a) {
        return Ut(e & n | ~e & r, t, e, o, i, a)
    }
    function At(t, e, n, r, o, i, a) {
        return Ut(e & r | n & ~r, t, e, o, i, a)
    }
    function Bt(t, e, n, r, o, i, a) {
        return Ut(e ^ n ^ r, t, e, o, i, a)
    }
    function Pt(t, e, n, r, o, i, a) {
        return Ut(n ^ (e | ~r), t, e, o, i, a)
    }
    function Ht(t, e) {
        var n, r, o, i, a;
        t[e >> 5] |= 128 << e % 32,
    ...
    function Yt(t, e) {
        return function(t, e) {
            ...
            o.length > 16 && (o = Ht(o, 8 * t.length)),
            n = 0; n < 16; n += 1)
                i[n] = 909522486 ^ o[n],
                a[n] = 1549556828 ^ o[n];
            return r = Ht(i.concat(qt(e)), 512 + 8 * e.length),
            $t(Ht(a.concat(r), 640))
        }(Vt(t), Vt(e))
    }
    function Xt(t, e, n) {
        return e ? n ? Yt(e, t) : Wt(Yt(e, t)) : n ? Gt(t) : Wt(Gt(t))
    }
    var zt = b()
      , Jt = {
        wrap: function() {
      ...
      , Kt = [].slice
      , Zt = "?"
      , Qt = /^(?:[Uu]ncaught (?:exception: )?)?(?:((?:Eval|Internal|Range|Reference|Syntax|Type|URI|)Error): )?(.*)$/;
    function te(t, e) {
    ...
    ,
    Jt.report = function() {
        var t, e, n, r, o = [], a = null, s = null;
        function u(t, e, n) {
            var r = null;
            if (!e || Jt.collectWindowErrors) {
                for (var i in o)
                    if (te(o, i))
                        try {
                            o[i](t, e, n)
        ...
        function c(e, n, r, o, a) {
            ...
            e = f(e) ? e.message : e,
            s)
                Jt.computeStackTrace.augmentStackTraceWithInitialElement(s, n, r, e),
                h();
            else if (a && p(a))
                (c = Jt.computeStackTrace(a)).mechanism = "onerror",
                u(c, !0, a);
            else {
                var l, d = {
                    url: n,
                ...
                d.func = Jt.computeStackTrace.guessFunctionName(d.url, d.line),
                d.context = Jt.computeStackTrace.gatherContext(d.url, d.line),
                u(c = {
                    name: l,
                    message: v,
                    mode: "onerror",
        ...
        d.installGlobalUnhandledRejectionHandler = function() {
            !0 !== r && (n = zt.onunhandledrejection,
            zt.onunhandledrejection = l,
            r = !0)
        }
        ,
        d
    }(),
    Jt.computeStackTrace = function() {
        var t = !1
          , e = {};
        function n(t) {
            if ("string" != typeof t)
                    ...
                    try {
                        var e = function() {
                            try {
                                ...
                                return new zt.ActiveXObject("Microsoft.XMLHTTP")
                            }
                        }();
        ...
        function r(t, e) {
            var r, o = /function ([^(]*)\(([^)]*)\)/, i = /['"]?([0-9A-Za-z$_]+)['"]?\s*[:=]\s*(function|eval|new Function)/, a = "", s = n(t);
            if (!s.length)
                return Zt;
            for (var u = 0; u < 10; ++u)
                if (!d(a = s[e - u] + a)) {
        ...
        function o(t, e) {
            ...
            if (!r.length)
                return null;
            var o = []
              , i = Math.floor(Jt.linesOfContext / 2)
              , a = i + Jt.linesOfContext % 2
              , s = Math.max(0, e - i - 1)
        ...
        function u(t, e, r) {
            var o, a = n(e), s = new RegExp("\\b" + i(t) + "\\b");
            return r -= 1,
            a && a.length > r && (o = s.exec(a[r])) ? o.index : null
        }
        function c(t) {
            if (!d(zt && zt.document)) {
                for (var e, n, r, o, u = [ee()], c = zt.document.getElementsByTagName("script"), l = "" + t, p = 0; p < c.length; ++p) {
                    var f = c[p];
                    f.src && u.push(f.src)
                }
                if (r = /^function(?:\s+([\w$]+))?\s*\(([\w\s,]*)\)\s*\{\s*(\S[\s\S]*\S)\s*\}\s*$/.exec(l)) {
                    ...
                    e = i(r[3]).replace(/;$/, ";?"),
                    n = new RegExp("function" + h + "\\s*\\(\\s*" + v + "\\s*\\)\\s*{\\s*" + e + "\\s*}")
                } else
        ...
        function l(t) {
            if (!t.stack)
                return null;
            for (var e, n, i, a = /^\s*at (?:(.*?) ?\()?((?:file|https?|blob|chrome-extension|native|eval|webpack|<anonymous>|[a-z]:|\/).*?)(?::(\d+))?(?::(\d+))?\)?\s*$/i, s = /^\s*(.*?)(?:\((.*?)\))?(?:^|@)((?:file|https?|blob|chrome|webpack|resource|moz-extension).*?:\/.*?|\[native code\]|[^@]*bundle)(?::(\d+))?(?::(\d+))?\s*$/i, c = /^\s*at (?:((?:\[object object\])?.+) )?\(?((?:file|ms-appx|https?|webpack|blob):.*?):(\d+)(?::(\d+))?\)?\s*$/i, l = /(\S+) line (\d+)(?: > eval line \d+)* > eval/i, p = /\((\S*)(?::(\d+))(?::(\d+))\)/, f = t.stack.split("\n"), h = [], v = /^(.*) is undefined$/.exec(t.message), g = 0, y = f.length; g < y; ++g) {
                if (n = a.exec(f[g])) {
                    ...
                    if (!(n = s.exec(f[g])))
                        continue;
                    n[3] && n[3].indexOf(" > eval") > -1 && (e = l.exec(n[3])) ? n[3] = e[1] : 0 !== g || n[5] || d(t.columnNumber) || (h[0].column = t.columnNumber + 1),
                    i = {
                        url: n[3],
                        func: n[1] || Zt,
                        args: n[2] ? n[2].split(",") : [],
                ...
                Jt.remoteFetching && i.url && "blob:" === i.url.substr(0, 5)) {
                    var b = new XMLHttpRequest;
                    if (b.open("GET", i.url, !1),
                    b.send(""),
                    200 === b.status) {
        ...
        function p(t, e, n, i) {
            ...
            if (a.url && a.line) {
                ...
                var s = / '([^']+)' /.exec(i);
                if (s && (a.column = u(s[1], a.url, a.line)),
        ...
        function f(t, e) {
            for (var n, o, i, a = /function\s+([_$a-zA-Z\xA0-\uFFFF][_$a-zA-Z0-9\xA0-\uFFFF]*)?\s*\(/i, s = [], l = {}, d = !1, v = f.caller; v && !d; v = v.caller)
                if (v !== h && v !== Jt.report) {
                    if (o = {
                        url: null,
                        func: Zt,
                    ...
                    if (i = c(v)) {
                        o.url = i.url,
                        o.line = i.line,
                        o.func === Zt && (o.func = r(o.url, o.line));
            ...
            return p(y, t.sourceURL || t.fileName, t.line || t.lineNumber, t.message || t.description),
            y
        }
        function h(e, i) {
            var u = null;
            ...
            try {
                if (u = function(t) {
                    ...
                    if (e.length < 4)
                        return null;
                    var i, u = /^\s*Line (\d+) of linked script ((?:file|https?|blob)\S+)(?:: in function (\S+))?\s*$/i, c = /^\s*Line (\d+) of inline#(\d+) script in ((?:file|https?|blob)\S+)(?:: in function (\S+))?\s*$/i, l = /^\s*Line (\d+) of function script\s*$/i, p = [], f = zt && zt.document && zt.document.getElementsByTagName("script"), h = [];
                    for (var d in f)
                        te(f, d) && !f[d].src && h.push(f[d]);
                    for (var v = 2; v < e.length; v += 2) {
                        ...
                        if (g) {
                            ...
                            S && w.replace(/^\s*/, "") === e[v + 1].replace(/^\s*/, "") ? g.context = S : g.context = [e[v + 1]],
                            p.push(g)
                        }
                    }
                    return p.length ? {
        ...
        return h.augmentStackTraceWithInitialElement = p,
    ...
    Jt.extendToAsynchronousCallbacks = function() {
        var t = function(t) {
            var e = zt[t];
            zt[t] = function() {
                var t = Kt.call(arguments)
                  , n = t[0];
                return "function" == typeof n && (t[0] = Jt.wrap(n)),
    ...
    ,
    Jt.remoteFetching = !1,
    Jt.collectWindowErrors = !0,
    Jt.linesOfContext = 11;
    var ne = Jt.report.subscribe
      , re = Jt.report.installGlobalHandler
      , oe = Jt.report.installGlobalUnhandledRejectionHandler
      , ie = Jt.computeStackTrace
      , ae = 50;
    function se(t) {
        var e = {
            stacktrace: {
        ...
        return void 0 === e.type && "" === e.value && (e.value = "Unrecoverable error caught"),
        e
    }
    function ue(t, e) {
          ...
          , r = {
            extra: {
                __serialized__: function t(e, n, r) {
                    ...
                    void 0 === r && (r = T);
                    var o = C(e, n);
                    return R(k(o)) > r ? t(e, n - 1) : o
                }(t)
            },
            fingerprint: [Xt(n.join(""))],
    ...
    function le(t) {
        ...
        var e = t
          , n = e[0].func || ""
          , r = e[e.length - 1].func || "";
        return (ot(n, "captureMessage") || ot(n, "captureException")) && (e = e.slice(1)),
        ot(r, "sentryWrapped") && (e = e.slice(0, -1)),
        e.map(function(t) {
            return {
                colno: t.column,
    ...
    var pe, fe, he = function() {
        function t(t) {
            this.options = t,
            this.url = new et(this.options.dsn).getStoreEndpointWithUrlEncodedAuth()
        }
        return t.prototype.captureEvent = function(t) {
            return a(this, void 0, void 0, function() {
                return s(this, function(t) {
                    throw new Z("Transport Class has to implement `captureEvent` method")
                })
            })
        }
        ,
        ...
        return n(r, e),
        r.prototype.captureEvent = function(e) {
            return a(this, void 0, void 0, function() {
                var n, r;
                return s(this, function(o) {
                    switch (o.label) {
        ...
        r.prototype.captureEvent = function(e) {
            return a(this, void 0, void 0, function() {
                ...
                return s(this, function(r) {
                    return n = k(e),
                    [2, {
                        status: ye.navigator.sendBeacon(this.url, n) ? t.Status.Success : t.Status.Failed
                    }]
                })
            })
        }
        ...
        r.prototype.install = function() {
            if (!this.options.dsn)
                throw new Z("Invariant exception: install() must not be called when disabled");
        ...
        r.prototype.eventFromException = function(t, e) {
            return a(this, void 0, void 0, function() {
                ...
                return s(this, function(s) {
                    switch (s.label) {
                    case 0:
                        return f(t) && t.error ? (t = (a = t).error,
                        n = ce(ie(t)),
                        [3, 7]) : [3, 1];
                    case 1:
                        return h(t) || (u = t,
                        "[object DOMException]" === Object.prototype.toString.call(u)) ? (r = (a = t).name || (h(a) ? "DOMError" : "DOMException"),
                        o = a.message ? r + ": " + a.message : r,
                        [4, this.eventFromMessage(o, void 0, e)]) : [3, 3];
                    case 2:
                        return n = s.sent(),
                        [3, 7];
                    case 3:
                        return p(t) ? (n = ce(ie(t)),
                        [3, 7]) : [3, 4];
                    case 4:
                        return y(t) && e && e.syntheticException ? (n = ue(a = t, e.syntheticException),
                        [3, 7]) : [3, 5];
                    case 5:
                        return a = t,
                        [4, this.eventFromMessage(a, void 0, e)];
                    case 6:
                        n = s.sent(),
                        s.label = 7;
                    case 7:
        ...
        r.prototype.eventFromMessage = function(e, n, r) {
            ...
            a(this, void 0, void 0, function() {
                ...
                return s(this, function(a) {
                    ...
                    this.options.attachStacktrace && r && r.syntheticException && (o = ie(r.syntheticException),
                    i = le(o.stack),
                    t.stacktrace = {
                        frames: i
                    }),
            ...
            return a(this, void 0, void 0, function() {
                ...
                return s(this, function(r) {
                    ...
                    this.options.transport ? this.transport = new this.options.transport({
                        dsn: this.options.dsn
                    }) : Nt() ? this.transport = new me(n) : Dt() ? this.transport = new ve(n) : this.transport = new ge(n)),
                    [2, this.transport.captureEvent(e)]) : (H.warn("Event has been skipped because no Dsn is configured."),
                    [2, {
                        status: t.Status.Skipped,
        ...
        ,
        r
    }(pt), xe = "sentry.javascript.browser", _e = function(t) {
        function e(e) {
        ...
        e.prototype.showReportDialog = function(t) {
            ...
            if (e) {
                ...
                if (!t.eventId)
                    throw new Z("Missing `eventId` option in showReportDialog call");
                if (!n)
                    throw new Z("Missing `Dsn` option in showReportDialog call");
                var r = e.createElement("script");
                r.async = !0,
                r.src = new et(n).getReportDialogEndpoint(t),
    ...
    function ke(t, e, n) {
                        ...
                        return s(this, function(u) {
                            return n.addEventProcessor(function(t) {
                                return a(r, void 0, void 0, function() {
                                    ...
                                    return s(this, function(r) {
                                        return n = i({}, t),
                                        e.mechanism && (n.exception = n.exception || {},
        ...
        return sentryWrapped.prototype = t.prototype,
    ...
    function Oe(t) {
        return function(e) {
            ...
            fe !== e) {
                ...
                try {
                    n = function(t) {
                        for (var e, n = t, r = [], o = 0, i = 0, a = " > ".length; n && o++ < 5 && !("html" === (e = x(n)) || o > 1 && i + r.length * a + e.length >= 80); )
                            r.push(e),
                            i += e.length,
                            n = n.parentNode;
                        return r.reverse().join(" > ")
    ...
    function je() {
        return function(t) {
            ...
            var n = e && e.tagName;
            n && ("INPUT" === n || "TEXTAREA" === n || e.isContentEditable) && (pe || Oe("input")(t),
            clearTimeout(pe),
    ...
    var Te, Ie = function() {
        ...
        return t.prototype.setupOnce = function() {
            ...
            this.options.onerror && (H.log("Global Handler attached: onerror"),
            re()),
            this.options.onunhandledrejection && (H.log("Global Handler attached: onunhandledrejection"),
            oe())
        }
        ,
        ...
        t.prototype.wrapEventTarget = function(t) {
            ...
            n && n.hasOwnProperty && n.hasOwnProperty("addEventListener") && (O(n, "addEventListener", function(e) {
                return function(n, r, o) {
                    ...
                    var i, a, s;
                    return "EventTarget" !== t && "Node" !== t || (a = Oe("click"),
                    s = je(),
                    i = function(t) {
                        if (t) {
                            var e;
        ...
        t.prototype.setupOnce = function() {
            ...
            var t = b();
            O(t, "setTimeout", this.wrapTimeFunction.bind(this)),
            O(t, "setInterval", this.wrapTimeFunction.bind(this)),
            O(t, "requestAnimationFrame", this.wrapRAF.bind(this)),
        ...
        return e.prototype.instrumentBeacon = function() {
            Nt() && O(Fe.navigator, "sendBeacon", function(n) {
                return function() {
                    ...
                    var i = r[0]
                      ...
                      , c = u && u.getDsn();
                    if (c) {
                        var l = new et(c).getStoreEndpoint();
                        if (l && ot(i, l))
                            return De(a),
                            s
                    }
                    ...
                    return s || (p.level = t.Severity.Error),
                    e.addBreadcrumb(p, {
                        input: r,
                        result: s
                    }),
        ...
        e.prototype.instrumentConsole = function() {
            "console"in Fe && ["debug", "info", "warn", "error", "log"].forEach(function(n) {
                n in Fe.console && O(Fe.console, n, function(r) {
                    return function() {
                        ...
                        "assert" === n && !1 === o[0] && (a.message = "Assertion failed: " + (rt(o.slice(1), " ") || "console.assert"),
                        a.data.extra.arguments = C(o.slice(1), 2)),
                        e.addBreadcrumb(a, {
                            input: o,
                            level: n
                        }),
                        r && Function.prototype.apply.call(r, Fe.console, o)
                    }
                })
            })
        }
        ...
        e.prototype.instrumentDOM = function() {
            "document"in Fe && (Fe.document.addEventListener("click", Oe("click"), !1),
            Fe.document.addEventListener("keypress", je(), !1))
        }
        ,
        e.prototype.instrumentFetch = function() {
            Dt() && -1 !== b().fetch.toString().indexOf("native") && O(Fe, "fetch", function(n) {
                return function() {
                    for (var r = [], o = 0; o < arguments.length; o++)
                        r[o] = arguments[o];
                    var i, a = r[0], s = "GET";
                    "string" == typeof a ? i = a : "Request"in Fe && a instanceof Request ? (i = a.url,
                    a.method && (s = a.method)) : i = String(a),
                    ...
                    if (c) {
                        var l = new et(c).getStoreEndpoint();
                        if (l && ot(i, l))
                            return "POST" === s && r[1] && r[1].body && De(r[1].body),
                            n.apply(Fe, r)
                    }
                    var p = {
                        method: s,
                    ...
                    return n.apply(Fe, r).then(function(t) {
        ...
        e.prototype.instrumentHistory = function() {
            ...
            !o && i) {
                var n, r, o, i, a = function(t, n) {
                    var r = _(Fe.location.href)
                      , o = _(n)
                      , i = _(t);
                    i.path || (i = r),
                    Te = n,
                ...
                Fe.onpopstate = function() {
                    for (var e = [], n = 0; n < arguments.length; n++)
                        e[n] = arguments[n];
                    var r = Fe.location.href;
                    if (a(Te, r),
                    s)
                        return s.apply(t, e)
                }
                ,
                O(Fe.history, "pushState", u),
                O(Fe.history, "replaceState", u)
            }
            function u(t) {
                return function() {
                    for (var e = [], n = 0; n < arguments.length; n++)
            ...
            if ("XMLHttpRequest"in Fe) {
                ...
                O(t, "open", function(t) {
                    return function() {
                        ...
                        var o = G().getClient()
                          , i = o && o.getDsn();
                        if (i) {
                            var a = new et(i).getStoreEndpoint();
                            g(r) && a && ot(r, a) && (this.__sentry_own_request__ = !0)
                        }
                ...
                O(t, "send", function(t) {
                    return function() {
                        ...
                        return o.__sentry_own_request__ && De(n[0]),
                        ["onload", "onerror", "onprogress"].forEach(function(t) {
                            !function(t, e) {
                                t in e && v(e[t]) && O(e, t, function(e) {
                                    return ke(e, {
                                        mechanism: {
                                            data: {
                                                function: t,
                        ...
                        "onreadystatechange"in o && v(o.onreadystatechange) ? O(o, "onreadystatechange", function(t) {
                            return ke(t, {
                                mechanism: {
                                    data: {
    ...
    function De(e) {
        try {
            ...
            H.error("Error while adding sentry type breadcrumb")
        }
        var r
    }
    var Ne, Me = "cause", Ue = 5, Le = function() {
        function t(e) {
            void 0 === e && (e = {}),
            this.name = t.id,
            this.key = e.key || Me,
        ...
        t.prototype.handler = function(t, e) {
            ...
            return t.exception.values = l(n, t.exception.values),
            t
        }
        ,
        t.prototype.walkErrorTree = function(t, e, n) {
            if (void 0 === n && (n = []),
            !(t[e]instanceof Error) || n.length + 1 >= this.limit)
                return n;
            var r = se(ie(t[e]));
        ...
        return t.prototype.setupOnce = function() {
            ...
            B(function(n) {
                return a(e, void 0, void 0, function() {
                    var e;
                    return s(this, function(r) {
                        return G().getIntegration(t) && Ae.navigator && Ae.location ? ((e = n.request || {}).url = e.url || Ae.location.href,
                        e.headers = e.headers || {},
                        e.headers["User-Agent"] = Ae.navigator.userAgent,
                        [2, i({}, n, {
                            request: e
                        })]) : [2, n]
                    })
        ...
        return t.prototype.setupOnce = function() {
            ...
            if (this.Ember) {
                ...
                this.Ember.onerror = function(r) {
                    if (G().getIntegration(t) && K(function(t) {
                        e.addIntegrationToSdkInfo(t),
                        captureException(r)
                    }),
                    "function" == typeof n)
                        n.call(e.Ember, r);
                    else if (e.Ember.testing)
                        throw r
                }
                ,
                this.Ember.RSVP.on("error", function(n) {
                    G().getIntegration(t) && K(function(t) {
                        n instanceof Error ? (t.setExtra("context", "Unhandled Promise error detected"),
                        e.addIntegrationToSdkInfo(t),
                        captureException(n)) : (t.setExtra("reason", n),
                        e.addIntegrationToSdkInfo(t),
        ...
        t.prototype.addIntegrationToSdkInfo = function(t) {
            ...
            t.addEventProcessor(function(t) {
                return a(e, void 0, void 0, function() {
                    var e;
                    return s(this, function(n) {
                        return t.sdk && (e = t.sdk.integrations || [],
                        t.sdk = i({}, t.sdk, {
        ...
        t.prototype.setupOnce = function() {
            ...
            if (this.Vue && this.Vue.config) {
                ...
                this.Vue.config.errorHandler = function(r, o, u) {
                    var c = {};
                    y(o) && (c.componentName = e.formatComponentName(o),
    ...
    var $e = function() {
                ...
                var o = function(t) {
                    K(function(e) {
                        ...
                        if (t.body) {
                            ...
                            for (var a in t.body)
                                i[a] = t.body[a];
                            if (e.setExtra("body", i),
                            t.type === Ne.Crash)
                                r = [(o = t.body).crashId || "", o.reason || ""].join(" ").trim() || r;
                            else
                                r = (o = t.body).message || r
                        }
                        captureMessage(n + ": " + r)
                    })
                };
      ...
      , We = [new ht, new yt, new dt, new kt, new Re, new Ce, new Ie, new Le, new Be];
    var Ve = i({}, Ct, qe);
    return t.Integrations = Ve,
    t.Transports = be,
    t.addGlobalEventProcessor = B,
    ...
    t.showReportDialog = function(t) {
        void 0 === t && (t = {}),
        t.eventId || (t.eventId = G().lastEventId()),
        G().getClient().showReportDialog(t)
    }
    ,
    t.SDK_NAME = xe,
    t.SDK_VERSION = "4.4.2",
