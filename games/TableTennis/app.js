          ...
          if (window.famobi.pointerLockHelper) {
            if (
              window.famobi.pointerLockHelper.mousePos.x + movementX <
                fenster.innerWidth &&
              window.famobi.pointerLockHelper.mousePos.x + movementX > 0
            )
              window.famobi.pointerLockHelper.mousePos.x += movementX;
            if (
              window.famobi.pointerLockHelper.mousePos.y + movementY <
                fenster.innerHeight &&
              window.famobi.pointerLockHelper.mousePos.y + movementY > 0
            )
              window.famobi.pointerLockHelper.mousePos.y += movementY;
          }
          userBat.targX =
            window.famobi.pointerLockHelper.mousePos.x * canvasScale;
          userBat.targY =
            window.famobi.pointerLockHelper.mousePos.y * canvasScale;
        } else {
          //pointerUnlocked
          userBat.targX = _posX * canvasScale;
          userBat.targY = _posY * canvasScale;
          if (window.famobi.pointerLockHelper)
            window.famobi.pointerLockHelper.mousePos = { x: _posX, y: _posY };
        }
      }
      if (_isDown) {
        _posX *= canvasScale;
...
(function (Elements) {
  var Background = (function () {
    function Background() {
      ...
      this.wallId = parseInt(
        forcedModeProperties.state.wall_id || oGameData.cupId % 5
      );
    }
    Background.prototype.renderGame = function () {
      ...
      ctx.fillRect(0, 0, canvas.width, canvas.height);
      var bX =
        this.oGameElementsImgData.oData.oAtlasData[oImageIds.tableBgBottom].x;
      var bY =
        this.oGameElementsImgData.oData.oAtlasData[oImageIds.tableBgBottom].y;
      var bWidth =
        this.oGameElementsImgData.oData.oAtlasData[oImageIds.tableBgBottom]
          .width;
      var bHeight =
        this.oGameElementsImgData.oData.oAtlasData[oImageIds.tableBgBottom]
          .height;
      ...
      ctx.drawImage(
        ...
        tempTop,
        canvas.width,
        (canvas.height - tempTop) * (1 + tableTop.offsetY / 3) * 1.1
      );
      var bX =
        this.oGameElementsImgData.oData.oAtlasData[
          oImageIds["tableBg" + this.wallId]
        ].x;
      var bY =
        this.oGameElementsImgData.oData.oAtlasData[
          oImageIds["tableBg" + this.wallId]
      ...
      ctx.drawImage(
        ...
        bHeight,
        0,
        canvas.height / 4 - 220 + tableTop.offsetY * 25,
        canvas.width,
        bHeight
      );
    };
  ...
  var Panel = (function () {
    ...
    Panel.prototype.render = function (_butsOnTop) {
      ...
      switch (this.panelType) {
        ...
        case "start":
          var bX =
            this.oUiElementsImgData.oData.oAtlasData[oImageIds.titleFadeBar].x;
          var bY =
            this.oUiElementsImgData.oData.oAtlasData[oImageIds.titleFadeBar].y;
          var bWidth =
            this.oUiElementsImgData.oData.oAtlasData[oImageIds.titleFadeBar]
              .width;
          var bHeight =
            this.oUiElementsImgData.oData.oAtlasData[oImageIds.titleFadeBar]
              .height;
          ctx.drawImage(
            ...
            bHeight,
            0,
            canvas.height * 0.57 - bHeight / 2 + this.posY / 2,
            canvas.width,
            bHeight
          );
          var bX =
            this.oUiElementsImgData.oData.oAtlasData[oImageIds.titleBats].x;
          var bY =
            this.oUiElementsImgData.oData.oAtlasData[oImageIds.titleBats].y;
          var bWidth =
            this.oUiElementsImgData.oData.oAtlasData[oImageIds.titleBats].width;
          var bHeight =
            this.oUiElementsImgData.oData.oAtlasData[oImageIds.titleBats]
              .height;
          ...
          ctx.drawImage(
            ...
            bWidth,
            bHeight,
            canvas.width / 2 - (bWidth / 2) * tempScale,
            canvas.height * 0.57 - (bHeight / 2) * tempScale - this.posY / 4,
            bWidth * tempScale,
            bHeight * tempScale
          );
          var bX =
            this.oUiElementsImgData.oData.oAtlasData[oImageIds.titleBall].x;
          var bY =
            this.oUiElementsImgData.oData.oAtlasData[oImageIds.titleBall].y;
          var bWidth =
            this.oUiElementsImgData.oData.oAtlasData[oImageIds.titleBall].width;
          var bHeight =
            this.oUiElementsImgData.oData.oAtlasData[oImageIds.titleBall]
              .height;
          ctx.drawImage(
            this.oUiElementsImgData.img,
            bX,
            ...
            bWidth,
            bHeight,
            canvas.width / 2 - (bWidth / 2 + 50) * tempScale,
            canvas.height * 0.57 -
              (bHeight / 2 + 50) * tempScale -
              this.posY / 3,
            bWidth * tempScale,
            bHeight * tempScale
          );
          var bX =
            this.oUiElementsImgData.oData.oAtlasData[oImageIds.globeLogo].x;
          var bY =
            this.oUiElementsImgData.oData.oAtlasData[oImageIds.globeLogo].y;
          var bWidth =
            this.oUiElementsImgData.oData.oAtlasData[oImageIds.globeLogo].width;
          var bHeight =
            this.oUiElementsImgData.oData.oAtlasData[oImageIds.globeLogo]
              .height;
          ctx.drawImage(
            this.oUiElementsImgData.img,
            bX,
            ...
            bWidth,
            bHeight,
            canvas.width / 2 - bWidth / 2,
            canvas.height * 0.2 - bHeight / 2 + 80 - this.posY / 2,
            bWidth,
            bHeight
          );
          var bX =
          ...
          ctx.drawImage(
            ...
            bHeight,
            canvas.width / 2 - bWidth / 2,
            canvas.height * 0.2 - bHeight / 2 - this.posY,
            bWidth,
            bHeight
          );
        ...
        case "chooseCountry":
          for (var i = 0; i < countryFlags.aIds.length / 2; i++) {
            ...
            var bX =
              this.oUiElementsImgData.oData.oAtlasData[oImageIds.countryBut].x;
            var bY =
              this.oUiElementsImgData.oData.oAtlasData[oImageIds.countryBut].y;
            var bWidth =
              this.oUiElementsImgData.oData.oAtlasData[oImageIds.countryBut]
                .width;
            var bHeight =
              this.oUiElementsImgData.oData.oAtlasData[oImageIds.countryBut]
                .height;
            ctx.drawImage(
              ...
              bWidth,
              bHeight,
              canvas.width / 2 - bWidth / 2 + ((i % 4) - 2) * 120 + 60,
              canvas.height / 2 -
                bHeight / 2 -
                (this.posY * 5) / (i + 1) +
                (Math.floor(i / 4) - 2.5) * 90 +
                45,
              bWidth,
              bHeight
            );
            ...
            ctx.drawImage(
              this.oCountryFlagsImgData.img,
              bData.bX,
              bData.bY,
              bData.bWidth,
              bData.bHeight,
              canvas.width / 2 - bData.bWidth / 2 + ((i % 4) - 2) * 120 + 60,
              canvas.height / 2 -
                bData.bHeight / 2 -
                (this.posY * 5) / (i + 1) +
                (Math.floor(i / 4) - 2.5) * 90 +
          ...
          var tempScale = 0.75;
          var imgX =
            (id * this.oSmallNumbersImgData.oData.spriteWidth) %
            this.oSmallNumbersImgData.img.width;
          var imgY =
            Math.floor(
              id /
                (this.oSmallNumbersImgData.img.width /
                  this.oSmallNumbersImgData.oData.spriteWidth)
            ) * this.oSmallNumbersImgData.oData.spriteHeight;
          ctx.drawImage(
            this.oSmallNumbersImgData.img,
            imgX,
            imgY,
            this.oSmallNumbersImgData.oData.spriteWidth,
            this.oSmallNumbersImgData.oData.spriteHeight,
            tempPosX,
            tempPosY - this.posY / 2,
            this.oSmallNumbersImgData.oData.spriteWidth * tempScale,
            this.oSmallNumbersImgData.oData.spriteHeight * tempScale
          );
          var id = 10;
          var imgX =
            (id * this.oSmallNumbersImgData.oData.spriteWidth) %
          ...
          ctx.drawImage(
            ...
            this.oSmallNumbersImgData.oData.spriteWidth,
            this.oSmallNumbersImgData.oData.spriteHeight,
            tempPosX + this.smallNumberSpace * tempScale,
            tempPosY - this.posY / 2,
            this.oSmallNumbersImgData.oData.spriteWidth * tempScale,
            this.oSmallNumbersImgData.oData.spriteHeight * tempScale
          );
          ...
          ctx.drawImage(
            ...
            this.oSmallNumbersImgData.oData.spriteWidth,
            this.oSmallNumbersImgData.oData.spriteHeight,
            tempPosX + this.smallNumberSpace * 2 * tempScale,
            tempPosY - this.posY / 2,
            this.oSmallNumbersImgData.oData.spriteWidth * tempScale,
            this.oSmallNumbersImgData.oData.spriteHeight * tempScale
          );
        ...
        case "map":
          ...
          ctx.drawImage(
            ...
            bHeight,
            0,
            canvas.height * 0.5 - bHeight / 2 + this.posY / 2,
            canvas.width,
            bHeight
          );
          ...
          var bWidth =
            this.oUiElementsImgData.oData.oAtlasData[oImageIds.map].width;
          var bHeight =
            this.oUiElementsImgData.oData.oAtlasData[oImageIds.map].height;
          ctx.drawImage(
            this.oUiElementsImgData.img,
            bX,
            bY,
            ...
            bHeight,
            canvas.width / 2 - bWidth / 2,
            canvas.height * 0.45 - bHeight / 2 - this.posY / 2,
            bWidth,
            bHeight
          );
          for (var i = 0; i < aMapMarkerPos.length; i++) {
            ...
            if (i < oGameData.cupId) {
              ...
              temp = 1;
              this.flare(tempX, tempY, 0.5);
            }
            var bX =
              this.oUiElementsImgData.oData.oAtlasData[
                oImageIds["mapMarker" + temp]
              ].x;
            var bY =
              this.oUiElementsImgData.oData.oAtlasData[
                oImageIds["mapMarker" + temp]
            ...
            for (var j = 0; j < tempNum.length; j++) {
              ...
              var imgX =
                (id * this.oLargeNumbersImgData.oData.spriteWidth) %
                this.oLargeNumbersImgData.img.width;
              var imgY =
                Math.floor(
                  id /
                    (this.oLargeNumbersImgData.img.width /
                      this.oLargeNumbersImgData.oData.spriteWidth)
                ) * this.oLargeNumbersImgData.oData.spriteHeight;
              ctx.drawImage(
                this.oLargeNumbersImgData.img,
                imgX,
                imgY,
                this.oLargeNumbersImgData.oData.spriteWidth,
                this.oLargeNumbersImgData.oData.spriteHeight,
                tempX +
                  (j * this.largeNumberSpace -
                    (tempNum.length * this.largeNumberSpace) / 2) *
                    tempScale -
                  2,
                tempY -
                  (this.oLargeNumbersImgData.oData.spriteHeight / 2) *
                    tempScale,
                this.oLargeNumbersImgData.oData.spriteWidth * tempScale,
                this.oLargeNumbersImgData.oData.spriteHeight * tempScale
              );
            }
            var tempScale = 0.5;
            if (temp == 2) {
              var bX =
                this.oUiElementsImgData.oData.oAtlasData[oImageIds.cup3].x;
              var bY =
                this.oUiElementsImgData.oData.oAtlasData[oImageIds.cup3].y;
              var bWidth =
                this.oUiElementsImgData.oData.oAtlasData[oImageIds.cup3].width;
              var bHeight =
                this.oUiElementsImgData.oData.oAtlasData[oImageIds.cup3].height;
              ctx.drawImage(
                this.oUiElementsImgData.img,
                bX,
                bY,
                bWidth,
                bHeight,
                tempX - (bWidth / 2) * tempScale + 26,
                tempY - (bHeight / 2) * tempScale - 12,
                bWidth * tempScale,
                bHeight * tempScale
              );
            } else if (temp == 1) {
              var bX =
                this.oUiElementsImgData.oData.oAtlasData[oImageIds.cup2].x;
              var bY =
                this.oUiElementsImgData.oData.oAtlasData[oImageIds.cup2].y;
              var bWidth =
                this.oUiElementsImgData.oData.oAtlasData[oImageIds.cup2].width;
              var bHeight =
                this.oUiElementsImgData.oData.oAtlasData[oImageIds.cup2].height;
              ctx.drawImage(
                this.oUiElementsImgData.img,
                bX,
                bY,
              ...
              ctx.drawImage(
                this.oUiElementsImgData.img,
                bX,
                bY + bHeight - (oGameData.gameId / 6) * bHeight,
                bWidth,
                Math.max((oGameData.gameId / 6) * bHeight, 0.1),
                tempX - (bWidth / 2) * tempScale + 26,
                tempY -
                  (bHeight / 2) * tempScale -
                  12 +
                  (bHeight - (oGameData.gameId / 6) * bHeight) * tempScale -
                  this.posY / 2,
                bWidth * tempScale,
                Math.max((oGameData.gameId / 6) * bHeight, 0.1) * tempScale
              );
            }
          }
          break;
        case "gameIntro":
          ...
          ctx.drawImage(
            ...
            bHeight,
            0,
            canvas.height * 0.6 - bHeight / 2 + this.posY / 2,
            canvas.width,
            bHeight
          );
          var bX =
          ...
          ctx.drawImage(
            ...
            bHeight,
            canvas.width / 2 - (bWidth / 2) * tempScale,
            canvas.height * 0.3 - (bHeight / 2) * tempScale - this.posY / 2,
            bWidth * tempScale,
            bHeight * tempScale
          );
          ...
          ctx.drawImage(
            ...
            this.oSmallNumbersImgData.oData.spriteWidth,
            this.oSmallNumbersImgData.oData.spriteHeight,
            tempPosX + this.smallNumberSpace,
            tempPosY - this.posY / 2,
            this.oSmallNumbersImgData.oData.spriteWidth,
            this.oSmallNumbersImgData.oData.spriteHeight
          );
          ...
          ctx.drawImage(
            ...
            this.oSmallNumbersImgData.oData.spriteWidth,
            this.oSmallNumbersImgData.oData.spriteHeight,
            tempPosX + this.smallNumberSpace * 2,
            tempPosY - this.posY / 2,
            this.oSmallNumbersImgData.oData.spriteWidth,
            this.oSmallNumbersImgData.oData.spriteHeight
          );
          ...
          var bWidth =
            this.oUiElementsImgData.oData.oAtlasData[oImageIds.cup0].width;
          var bHeight =
            this.oUiElementsImgData.oData.oAtlasData[oImageIds.cup0].height;
          ctx.drawImage(
            this.oUiElementsImgData.img,
            bX,
            bY,
          ...
          if (Math.floor(this.cupFlipInc) % 2 == 0) {
            ...
            ctx.drawImage(
              this.oUiElementsImgData.img,
              bX,
              bY + bHeight - (tempGameId / 6) * bHeight,
              bWidth,
              Math.max((1 / 6) * bHeight, 0.1),
              5,
              5 +
                (bHeight - (tempGameId / 6) * bHeight) * tempScale -
                this.posY / 2,
              bWidth * tempScale,
              Math.max((1 / 6) * bHeight, 0.1) * tempScale
            );
          }
          var tempCup = 3;
          var bX =
            this.oUiElementsImgData.oData.oAtlasData[oImageIds["cup" + tempCup]]
              .x;
          var bY =
            this.oUiElementsImgData.oData.oAtlasData[oImageIds["cup" + tempCup]]
              .y;
          ...
          ctx.drawImage(
            ...
            bY + bHeight - (tempGameId / 6) * bHeight,
            bWidth,
            Math.max((tempGameId / 6) * bHeight, 0.1),
            5,
            5 +
              (bHeight - (tempGameId / 6) * bHeight) * tempScale -
              this.posY / 2,
            bWidth * tempScale,
            Math.max((tempGameId / 6) * bHeight, 0.1) * tempScale
          );
          var id = 10;
          var imgX =
            (id * this.oLargeNumbersImgData.oData.spriteWidth) %
          ...
          ctx.drawImage(
            ...
            this.oLargeNumbersImgData.oData.spriteHeight,
            canvas.width / 2 -
              this.oLargeNumbersImgData.oData.spriteWidth / 2 -
              this.largeNumberSpace / 2,
            canvas.height * 0.2 -
              this.oLargeNumbersImgData.oData.spriteHeight / 2 -
              this.posY,
            this.oLargeNumbersImgData.oData.spriteWidth,
          ...
          var bWidth =
            this.oUiElementsImgData.oData.oAtlasData[oImageIds.vsText].width;
          var bHeight =
            this.oUiElementsImgData.oData.oAtlasData[oImageIds.vsText].height;
          ctx.drawImage(
            this.oUiElementsImgData.img,
            bX,
            bY,
            ...
            bHeight,
            canvas.width / 2 - bWidth / 2,
            canvas.height * 0.6 - bHeight / 2 - this.posY / 4,
            bWidth,
            bHeight
          );
          ...
          ctx.drawImage(
            ...
            bData.bWidth,
            bData.bHeight,
            canvas.width / 2 - (bData.bWidth / 2) * tempScale - 120,
            canvas.height * 0.6 -
              (bData.bHeight / 2) * tempScale -
              this.posY / 4,
            bData.bWidth * tempScale,
            bData.bHeight * tempScale
          );
        ...
        case "game":
          ...
          let show_flags = true;
          if (
            forcedModeProperties != null &&
            forcedModeProperties.override != null &&
            Array.isArray(forcedModeProperties.override.hide_ui)
          ) {
            show_score =
              !forcedModeProperties.override.hide_ui.includes("score");
            show_flags =
              !forcedModeProperties.override.hide_ui.includes("flags");
          }
          if (show_score) {
            var bX =
              this.oGameElementsImgData.oData.oAtlasData[oImageIds.scoreCard].x;
            var bY =
              this.oGameElementsImgData.oData.oAtlasData[oImageIds.scoreCard].y;
            var bWidth =
              this.oGameElementsImgData.oData.oAtlasData[oImageIds.scoreCard]
                .width;
            var bHeight =
              this.oGameElementsImgData.oData.oAtlasData[oImageIds.scoreCard]
                .height;
            ctx.drawImage(
              ...
              bWidth,
              bHeight,
              canvas.width / 2 - bWidth / 2 - 22,
              0 - this.posY / 2,
              bWidth,
              bHeight * this.userCardScale
            );
            ...
            for (var i = 0; i < tempScore.length; i++) {
              ...
              ctx.drawImage(
                ...
                canvas.width / 2 -
                  24 +
                  i * this.scoreNumberSpace -
                  (tempScore.length * this.scoreNumberSpace) / 2,
                15 - this.posY / 2,
                this.oScoreNumbersImgData.oData.spriteWidth,
                this.oScoreNumbersImgData.oData.spriteHeight *
                  this.userCardScale
          ...
          if (show_flags) {
            ...
            ctx.drawImage(
              ...
              bData.bWidth,
              bData.bHeight,
              canvas.width / 2 - (bData.bWidth / 2) * tempScale - 80,
              10 - this.posY,
              bData.bWidth * tempScale,
              bData.bHeight * tempScale
            );
          ...
          if (firstRun) {
            ...
            ctx.fillRect(0, 0, canvas.width, canvas.height);
            var bX =
              this.oUiElementsImgData.oData.oAtlasData[oImageIds.tutScreen].x;
            var bY =
              this.oUiElementsImgData.oData.oAtlasData[oImageIds.tutScreen].y;
            var bWidth =
              this.oUiElementsImgData.oData.oAtlasData[oImageIds.tutScreen]
                .width;
            var bHeight =
              this.oUiElementsImgData.oData.oAtlasData[oImageIds.tutScreen]
                .height;
            ctx.drawImage(
              ...
              bHeight,
              canvas.width / 2 - bWidth / 2,
              canvas.height / 2 - bHeight / 2 - this.posY / 2,
              bWidth,
              bHeight
            );
            var tempId = 0;
            ...
            ctx.save();
            ctx.translate(
              canvas.width / 2 + this.enemyBatX,
              canvas.height / 2 + this.enemyBatY - this.posY / 2
            );
            ctx.rotate(this.enemyBatX / 100);
            ctx.scale(tempScale, tempScale);
            var bX =
              this.oGameElementsImgData.oData.oAtlasData[
                oImageIds["enemyBat" + tempId]
              ].x;
            var bY =
              this.oGameElementsImgData.oData.oAtlasData[
                oImageIds["enemyBat" + tempId]
            ...
            if (this.ballY < 20) {
              var bX =
                this.oGameElementsImgData.oData.oAtlasData[oImageIds.ballShadow]
                  .x;
              var bY =
                this.oGameElementsImgData.oData.oAtlasData[oImageIds.ballShadow]
                  .y;
              ...
              ctx.drawImage(
                ...
                bWidth,
                bHeight,
                canvas.width / 2 + this.ballX - (bWidth / 2) * tempScale,
                canvas.height / 2 +
                  this.ballY -
                  (bHeight / 2) * tempScale -
                  this.posY / 2,
            ...
            tempScale = 0.4;
            var bX =
              this.oGameElementsImgData.oData.oAtlasData[oImageIds.ball].x;
            var bY =
              this.oGameElementsImgData.oData.oAtlasData[oImageIds.ball].y;
            var bWidth =
              this.oGameElementsImgData.oData.oAtlasData[oImageIds.ball].width;
            var bHeight =
              this.oGameElementsImgData.oData.oAtlasData[oImageIds.ball].height;
            ctx.drawImage(
              this.oGameElementsImgData.img,
              bX,
              bY,
            ...
            ctx.save();
            ctx.translate(
              canvas.width / 2 + this.userBatX,
              canvas.height / 2 + this.userBatY - this.posY / 2
            );
            ...
            tempScale = 0.4;
            var bX =
              this.oGameElementsImgData.oData.oAtlasData[oImageIds.finger].x;
            var bY =
              this.oGameElementsImgData.oData.oAtlasData[oImageIds.finger].y;
            var bWidth =
              this.oGameElementsImgData.oData.oAtlasData[oImageIds.finger]
                .width;
            var bHeight =
              this.oGameElementsImgData.oData.oAtlasData[oImageIds.finger]
                .height;
        ...
        case "gameComplete":
          if (oGameData.userScore > oGameData.enemyScore) {
            this.flare(canvas.width / 2, canvas.height * 0.2 - 10 - this.posY);
          }
          var bX =
            this.oUiElementsImgData.oData.oAtlasData[oImageIds.titleFadeBar].x;
          var bY =
          ...
          ctx.drawImage(
            ...
            bHeight,
            0,
            canvas.height * 0.55 - bHeight / 2 + this.posY / 2,
            canvas.width,
            bHeight
          );
          ...
          if (!justWonCup) {
            if (!forcedMode) {
              var tempScale = 0.8;
              var bX =
                this.oUiElementsImgData.oData.oAtlasData[oImageIds.cup0].x;
              var bY =
                this.oUiElementsImgData.oData.oAtlasData[oImageIds.cup0].y;
              var bWidth =
                this.oUiElementsImgData.oData.oAtlasData[oImageIds.cup0].width;
              var bHeight =
                this.oUiElementsImgData.oData.oAtlasData[oImageIds.cup0].height;
            ...
            var bWidth =
              this.oUiElementsImgData.oData.oAtlasData[tempIcon].width;
            var bHeight =
              this.oUiElementsImgData.oData.oAtlasData[tempIcon].height;
            ctx.drawImage(
              this.oUiElementsImgData.img,
              bX,
              bY,
          ...
          ctx.drawImage(
            ...
            bHeight,
            canvas.width / 2 - bWidth / 2,
            canvas.height * 0.55 - bHeight / 2 + 80 - this.posY / 4,
            bWidth,
            bHeight
          );
          var tempScore = oGameData.userScore.toString();
          for (var i = 0; i < tempScore.length; i++) {
            ...
            ctx.drawImage(
              ...
              canvas.width / 2 -
                120 +
                i * this.largeNumberSpace -
                (tempScore.length * this.largeNumberSpace) / 2,
              canvas.height * 0.55 - 10 - bHeight / 2 - this.posY / 3,
              this.oLargeNumbersImgData.oData.spriteWidth,
              this.oLargeNumbersImgData.oData.spriteHeight
            );
          }
          ...
          ctx.drawImage(
            ...
            this.oLargeNumbersImgData.oData.spriteWidth,
            this.oLargeNumbersImgData.oData.spriteHeight,
            canvas.width / 2 - this.oLargeNumbersImgData.oData.spriteWidth / 3,
            canvas.height * 0.55 -
              10 -
              this.oLargeNumbersImgData.oData.spriteHeight / 2 -
              this.posY / 2,
    ...
    Panel.prototype.flare = function (_x, _y, _scale) {
      ...
      var bWidth =
        this.oUiElementsImgData.oData.oAtlasData[oImageIds.flare].width;
      var bHeight =
        this.oUiElementsImgData.oData.oAtlasData[oImageIds.flare].height;
      ctx.drawImage(
        this.oUiElementsImgData.img,
        bX,
        bY,
  ...
  var UserBat = (function () {
    ...
    UserBat.prototype.update = function () {
      ...
      this.rotation = Math.max(
        Math.min((this.x - canvas.width / 2) / 200, 90 * radian),
        -90 * radian
      );
    ...
    UserBat.prototype.getHitData = function (_tablePosX, _tablePosY) {
      ...
      var tempX =
        Math.max(Math.min((this.x - this.prevX) / delta, 3500), -3500) / 3500;
      var tempY = Math.max(
        Math.min((this.prevY - this.y) / delta, 4500) / 4500,
        0
      );
      var tempSpin = 0;
      if (tempY < 0.5) {
      ...
      this.hitX = tempX + _tablePosX * 0.8;
    ...
    UserBat.prototype.render = function () {
      ...
      ctx.scale(
        ...
        this.scale *
          Math.min(
            1 - ((this.y - canvas.height * 0.5) / (canvas.height * 0.5)) * 0.3,
            1
          )
      );
      ctx.rotate(this.rotation);
      var bX =
        this.oGameElementsImgData.oData.oAtlasData[oImageIds.userBatCentre].x;
      var bY =
        this.oGameElementsImgData.oData.oAtlasData[oImageIds.userBatCentre].y;
      var bWidth =
        this.oGameElementsImgData.oData.oAtlasData[oImageIds.userBatCentre]
          .width;
      var bHeight =
        this.oGameElementsImgData.oData.oAtlasData[oImageIds.userBatCentre]
          .height;
      ...
      ctx.translate(
        ...
        Math.min(
          7 *
            Math.max((this.y - canvas.height * 0.5) / (canvas.height * 0.5), 0),
          7
        )
      );
      ctx.rotate(this.rotation);
      var bX =
        this.oGameElementsImgData.oData.oAtlasData[oImageIds.userBatEdge].x;
      var bY =
        this.oGameElementsImgData.oData.oAtlasData[oImageIds.userBatEdge].y;
      var bWidth =
        this.oGameElementsImgData.oData.oAtlasData[oImageIds.userBatEdge].width;
      var bHeight =
        this.oGameElementsImgData.oData.oAtlasData[oImageIds.userBatEdge]
          .height;
      ctx.drawImage(
        this.oGameElementsImgData.img,
        bX,
...
(function (Elements) {
  var EnemyBat = (function () {
    function EnemyBat() {
      ...
      if (forcedMode) {
        if (
          ...
          console.log(
            "Difficulty: " +
              forcedModeProperties.override.enemy_difficulty +
              " => " +
              this.skillLevel
          );
        }
        ...
        if (oGameData.cupId == 0) {
          ...
          this.skillLevel =
            (2.5 +
              (7.5 / 9) * (oGameData.cupId - 1) +
              (oGameData.gameId + 1) * (7.5 / 9 / 6)) /
            10;
        }
      }
    }
    ...
    EnemyBat.prototype.setBouncePos = function (
      _targBounceX,
      _targBounceY,
      _spin
    ) {
      ...
      var tableImgHeight =
        this.oGameElementsImgData.oData.oAtlasData[oImageIds.table0].height;
      if ((_spin == 0 || Math.random() * 1 < 0.25) && ball.servingState != 1) {
        this.trackBall = false;
        var badAim = 0;
        if (Math.random() * 1 > 0.75 + this.skillLevel * 0.2) {
          badAim = Math.random() * 100 - 50;
        }
        var tempY =
          (_targBounceY * _targBounceY * 235 * (1 + tableTop.offsetY / 2)) / 2;
        var tempX =
          tempY *
            (tableTop.offsetX + _targBounceX * 0.6) *
            1.28 *
            (1 + tableTop.offsetY / 2) +
          (_targBounceX * 233) / 2 +
          _spin * 100;
        this.moveTween = TweenLite.to(
          this,
          (Math.random() * 0.35 + 0.3) * (1 + (1 - this.skillLevel) * 0.75),
          {
            ...
            onComplete: function () {
              if (ball.lastHit == "enemy") {
                _this.moveTween = TweenLite.to(
                  _this,
                  (Math.random() * 0.35 + 0.3) *
                    (1 + (1 - _this.skillLevel) * 0.5),
                  {
                    delay:
                      Math.random() * 0.3 * (1 + (1 - _this.skillLevel) * 0.5),
        ...
        this.moveTween = TweenLite.to(
          this,
          (Math.random() * 0.35 + 0.3) * (1 + (1 - this.skillLevel) * 0.5),
          {
            targY: 0,
            ease: "Quad.easeInOut",
          }
    ...
    EnemyBat.prototype.update = function () {
      ...
      if (!this.trackBall) {
        ...
        if (this.x > ball.x + 15) {
          this.slideInc = Math.max(
            this.slideInc - 1000 * delta,
            -50 + -50 * this.skillLevel
          );
        } else if (this.x < ball.x - 15) {
          this.slideInc = Math.min(
            this.slideInc + 1000 * delta,
            50 + 50 * this.skillLevel
          );
        }
      ...
      this.x = Math.min(
        Math.max(this.x, canvas.width / 2 - 250),
        canvas.width / 2 + 250
      );
    };
    EnemyBat.prototype.getHitData = function (_tablePosX, _tablePosY) {
      if (ball.servingState == 0) {
        ...
        this.hitY = Math.random() * 0.2 + 0.65;
      } else {
        this.hitX =
          (Math.random() * 2 - 1) * (1 + (1 - this.skillLevel) * 0.25);
        this.hitY = Math.random() * 0.4 + 0.65;
      }
      var tempSpin = 0;
      if (this.hitY < 0.8) {
        if (this.hitX > 0.1) {
          tempSpin = Math.random() * -1 * (0.75 + this.skillLevel * 0.25);
        } else if (this.hitX < -0.1) {
          tempSpin = Math.random() * 1 * (0.75 + this.skillLevel * 0.25);
        }
      }
      if (
        ...
        if (forcedModeProperties.override.curve_mode) {
          ...
          tempSpin =
            (Math.random() * 2 - 1) *
            (0.75 + this.skillLevel * 0.25) *
            curve_strength;
        }
      }
      var tempSpeed =
        0.3 + (0.3 / 0.4) * (this.hitY - 0.6) * (0.25 + this.skillLevel * 0.75);
    ...
    EnemyBat.prototype.render = function () {
      ...
      ctx.translate(
        this.x +
          (tableTop.offsetX + 0.8 * this.flailInc) * tableTop.sideMultiplier,
        this.y
      );
      ctx.rotate(this.rotation);
  ...
  var Ball = (function () {
    ...
    Ball.prototype.setBouncePoint = function (_oTargBouncePoints) {
      ...
      if (this.lastHit == "enemy") {
        ...
        if (this.servingState == 0) {
          this.servingState = 1;
          this.heightInc =
            -(-2400 + this.height * 6) * (0.8 - this.speed) * 1.2;
      ...
      this.tableVX =
        (this.targBounceX - this.tablePosX) / ((1 - this.speed) * 1.1);
      this.tableVY =
        (this.targBounceY - this.tablePosY) / ((1 - this.speed) * 1.1);
    };
      ...
      if (this.servingState == 0) {
        if (this.lastHit == "user") {
          this.y =
            canvas.height / 4 +
            tableTop.offsetY * 50 +
            this.tablePosY * this.tablePosY * 235 * (1 + tableTop.offsetY / 2) +
            (1 - this.servePosInc) * 100;
          this.tablePosX = Math.min(
            Math.max((userBat.x - canvas.width / 2) / 300, -0.95),
            0.95
          );
          this.x =
            canvas.width / 2 +
            ((this.y - canvas.height / 4) *
              (tableTop.offsetX + this.tablePosX * 0.6) *
              1.28 *
              (1 + tableTop.offsetY / 2) +
              (this.tablePosX * 233) / 2 +
              tableTop.offsetX * tableTop.sideMultiplier) +
            (1 - this.servePosInc) * -500;
          this.scale = 0.27 + (this.y - canvas.height / 4) / 600;
          if (
            this.canHit &&
            userBat.getHitData(this.tablePosX, this.tablePosY).y < 0.4
          ) {
            if (
              ...
              this.lastHit = "user";
              this.setBouncePoint(
                userBat.getHitData(this.tablePosX, this.tablePosY)
              );
            }
          }
        } else {
        ...
        if (!this.offTable) {
          if (this.lastHit == "user") {
            this.spinInc = Math.min(
              Math.max(
                this.spinInc +
                  Math.pow(this.spin * 2.5, 3) * delta * (1 - this.tablePosY),
                -3
              ),
              3
            );
            ...
            this.spinInc = Math.min(
              Math.max(
                this.spinInc +
                  Math.pow(this.spin * 2, 3) * delta * this.tablePosY,
                -2
              ),
              2
            );
        ...
        if (
          ...
          (this.tablePosX < -1 || this.tablePosX > 1) &&
          !this.offTable &&
          this.tablePosY < 1 &&
          this.height <= 0
        ) {
        ...
        if ((this.offTable || this.offSide) && this.height <= -200) {
          if (this.lastHit == "user") {
            if (this.bounceNum == (this.isFirstHit ? 2 : 1)) {
              updateScore("user");
            } else {
              updateScore("enemy");
            }
          ...
          if (
            (oGameData.userScore + oGameData.enemyScore) % 2 == 0 ||
            (oGameData.userScore >= 10 && oGameData.enemyScore >= 10)
          ) {
        ...
        if (
          this.lastHit == "enemy" &&
          ((this.servingState == 2 && this.bounceNum == 1) ||
            (this.servingState == 1 && this.bounceNum == 2)) &&
          !(this.height < 0 && this.bounceNum == 0) &&
          this.tablePosY > 0.5 &&
          userBat.x > this.x - 82 * userBat.scale &&
          userBat.x < this.x + 82 * userBat.scale &&
          userBat.y >
            this.y - this.height * (this.scale * 3) - 16 - 82 * userBat.scale &&
          userBat.y <
            this.y - this.height * (this.scale * 3) - 16 + 82 * userBat.scale
        ) {
          ...
          if (userBat.getHitData(this.tablePosX, this.tablePosY).spin != 0) {
            ...
            userBat.getHitData(this.tablePosX, this.tablePosY).speed >= 0.5
          ) {
            window.famobi_analytics.trackStats("ball_hit", {
              hit_type: "powerBall",
            });
        ...
        if (
          ...
          this.tablePosY < 0.5 &&
          this.tablePosY > 0 &&
          enemyBat.x > this.x - 70 * enemyBat.scale &&
          enemyBat.x < this.x + 70 * enemyBat.scale &&
          enemyBat.y >
            this.y -
              this.height * (this.scale * 3) -
              ...
              70 * enemyBat.scale &&
          enemyBat.y <
            this.y - this.height * (this.scale * 3) - 16 + 70 * enemyBat.scale
        ) {
          playSound("hit" + Math.floor(Math.random() * 6));
          rallyHits++;
          this.servingState = 2;
          ...
          this.lastHit = "enemy";
          this.setBouncePoint(
            enemyBat.getHitData(this.tablePosX, this.tablePosY)
          );
          if (enemyBat.getHitData(this.tablePosX, this.tablePosY).spin != 0) {
            enemy_hitType = "curvedBall";
          } else if (
            enemyBat.getHitData(this.tablePosX, this.tablePosY).speed >= 0.5
          ) {
    ...
    Ball.prototype.render = function () {
      if (
        ...
        var bX =
          this.oGameElementsImgData.oData.oAtlasData[oImageIds.ballShadow].x;
        var bY =
          this.oGameElementsImgData.oData.oAtlasData[oImageIds.ballShadow].y;
        var bWidth =
          this.oGameElementsImgData.oData.oAtlasData[oImageIds.ballShadow]
            .width;
        var bHeight =
    ...
    Ball.prototype.renderTrail = function () {
      var tempTrailNum = Math.floor(
        (this.aTrailPoints.length / 0.3) *
          (Math.max(Math.min(this.speed, 0.6), 0.3) - 0.3)
      );
      for (var i = 0; i < tempTrailNum; i++) {
        ...
        ctx.drawImage(
          ...
          bWidth,
          bHeight,
          this.aTrailPoints[temp].x -
            (bWidth / 2) * this.aTrailPoints[temp].scale,
          this.aTrailPoints[temp].y -
            (bHeight / 2) * this.aTrailPoints[temp].scale -
            this.aTrailPoints[temp].height *
              (this.aTrailPoints[temp].scale * 3) -
            16,
          bWidth * this.aTrailPoints[temp].scale,
          bHeight * this.aTrailPoints[temp].scale
        );
      }
    };
    return Ball;
...
(function (Elements) {
  var TableTop = (function () {
    ...
    TableTop.prototype.tweenToPos = function (_x, _y, _speed, _hitBy, _spin) {
      ...
      if (_hitBy == "enemy") {
        tempTime = 0.5;
        tempY = ((1 - (_y - 0.5) * 2) * (0.3 - (_speed - 0.3))) / 0.3;
      }
    ...
    TableTop.prototype.render = function () {
      var bHeight =
        this.oGameElementsImgData.oData.oAtlasData[oImageIds.net].height;
      this.netY =
        canvas.height / 4 -
        bHeight +
        (this.oGameElementsImgData.oData.oAtlasData[oImageIds.table0].height /
      ...
      var bX =
        this.oGameElementsImgData.oData.oAtlasData[oImageIds.tableClip].x;
      var bY =
        this.oGameElementsImgData.oData.oAtlasData[oImageIds.tableClip].y;
      var bWidth =
        this.oGameElementsImgData.oData.oAtlasData[oImageIds.tableClip].width;
      var bHeight =
        this.oGameElementsImgData.oData.oAtlasData[oImageIds.tableClip].height;
      ctx.drawImage(
        this.oGameElementsImgData.img,
        bX,
        bY,
        ...
        bHeight,
        canvas.width / 2 -
          (bWidth / 2) * (1 + this.offsetY / 3) +
          this.offsetX * (0.282 * this.segs) * 3 * (1 + this.offsetY / 3) +
          this.offsetX * this.sideMultiplier,
        this.netY + this.netHeight - 3 * (1 + this.offsetY / 3),
        bWidth * (1 + this.offsetY / 3),
        bHeight * (1 + this.offsetY / 3)
      );
      ctx.drawImage(
        this.oShadowImgData.img,
        0,
        0,
        this.oShadowImgData.img.width,
        this.oShadowImgData.img.height,
        canvas.width / 2 -
          (this.oShadowImgData.img.width / 2) * (1 + this.offsetY / 3) +
          this.offsetX * 100 * 2.3 * (1 + this.offsetY / 3) +
          this.offsetX * this.sideMultiplier,
        canvas.height / 4 +
          this.oGameElementsImgData.oData.oAtlasData[oImageIds.table0].height *
            (1 + this.offsetY / 3.5) +
          this.offsetY * 50 -
          80,
        this.oShadowImgData.img.width * (1 + this.offsetY / 3),
        this.oShadowImgData.img.height * (1 + this.offsetY / 3)
      );
      var bX =
        this.oGameElementsImgData.oData.oAtlasData[oImageIds.tableLegs].x;
      var bY =
        this.oGameElementsImgData.oData.oAtlasData[oImageIds.tableLegs].y;
      var bWidth =
        this.oGameElementsImgData.oData.oAtlasData[oImageIds.tableLegs].width;
      var bHeight =
        this.oGameElementsImgData.oData.oAtlasData[oImageIds.tableLegs].height;
      ctx.drawImage(
        this.oGameElementsImgData.img,
        bX,
        bY,
      ...
      var bX =
        this.oGameElementsImgData.oData.oAtlasData[oImageIds["table" + this.id]]
          .x;
      var bY =
        this.oGameElementsImgData.oData.oAtlasData[oImageIds["table" + this.id]]
          .y;
      ...
      for (var i = 0; i < this.segs; i++) {
        ctx.drawImage(
          ...
          canvas.width / 2 -
            ...
            this.offsetX * this.sideMultiplier,
          canvas.height / 4 +
            (bHeight / this.segs) * i * (1 + this.offsetY / 2) +
            this.offsetY * 50,
          bWidth * (1 + this.offsetY / 3),
          (bHeight / this.segs) * (1 + this.offsetY / 2)
        );
      }
      var bX =
        this.oGameElementsImgData.oData.oAtlasData[oImageIds.tableEdge].x;
      var bY =
        this.oGameElementsImgData.oData.oAtlasData[oImageIds.tableEdge].y;
      var bWidth =
        this.oGameElementsImgData.oData.oAtlasData[oImageIds.tableEdge].width;
      var bHeight =
        this.oGameElementsImgData.oData.oAtlasData[oImageIds.tableEdge].height;
      ctx.drawImage(
        this.oGameElementsImgData.img,
        bX,
        bY,
        ...
        canvas.width / 2 -
          (bWidth / 2) * (1 + this.offsetY / 3) +
          this.offsetX * 100 * 3 * (1 + this.offsetY / 3) +
          this.offsetX * this.sideMultiplier,
        canvas.height / 4 +
          this.oGameElementsImgData.oData.oAtlasData[oImageIds.table0].height *
            (1 + this.offsetY / 2) +
      ...
      if (this.bounceMarkScale > 0) {
        var bX =
          this.oGameElementsImgData.oData.oAtlasData[oImageIds.bounceMark].x;
        var bY =
          this.oGameElementsImgData.oData.oAtlasData[oImageIds.bounceMark].y;
        var bWidth =
          this.oGameElementsImgData.oData.oAtlasData[oImageIds.bounceMark]
            .width;
        var bHeight =
          this.oGameElementsImgData.oData.oAtlasData[oImageIds.bounceMark]
            .height;
        var tempY =
          canvas.height / 4 +
          this.offsetY * 50 +
          ball.bounceY * ball.bounceY * 235 * (1 + this.offsetY / 2);
        var tempX =
          canvas.width / 2 +
          (tempY - canvas.height / 4) *
            (this.offsetX + ball.bounceX * 0.6) *
            1.28 *
            (1 + this.offsetY / 2) +
          (ball.bounceX * 233) / 2 +
          this.offsetX * this.sideMultiplier;
        var tempScale = 0.27 + (tempY - canvas.height / 4) / 600;
        ctx.drawImage(
          this.oGameElementsImgData.img,
          bX,
          bY,
          bWidth,
          bHeight,
          tempX - (bWidth / 2) * (tempScale * this.bounceMarkScale),
          tempY - (bHeight / 2) * (tempScale * this.bounceMarkScale),
          bWidth * (tempScale * this.bounceMarkScale),
          bHeight * (tempScale * this.bounceMarkScale)
        );
      }
    };
    TableTop.prototype.renderNet = function () {
      ...
      var bWidth =
        this.oGameElementsImgData.oData.oAtlasData[oImageIds.net].width;
      var bHeight =
        this.oGameElementsImgData.oData.oAtlasData[oImageIds.net].height;
      ctx.drawImage(
        this.oGameElementsImgData.img,
...
function initStartScreen() {
  ...
  if (audioType == 1) {
    music.fade(music.volume(), 0.5 * masterVolume, 500);
  }
  ...
  var aButs = new Array(oMoreGamesBut, oPlayBut);
...
function initChooseCountry() {
  ...
  var bHeight =
    oUiElementsImgData.oData.oAtlasData[oImageIds.countryBut].height;
  for (var i = 0; i < countryFlags.aIds.length / 2; i++) {
    var tempI = i + flagPage * (countryFlags.aIds.length / 2);
    var tempX = canvas.width / 2 - bWidth / 2 + ((i % 4) - 2) * 120 + 60;
    var tempY =
      canvas.height / 2 - bHeight / 2 + (Math.floor(i / 4) - 2.5) * 90 + 45;
    userInput.addHitArea(
      "countryChoice",
      butEventHandler,
      {
      ...
      "rect",
      {
        aRect: [tempX, tempY, tempX + bWidth, tempY + bHeight],
      },
      false
    );
  }
...
function initMapScreen() {
  ...
  for (var i = 0; i < aMapMarkerPos.length; i++) {
    if (i == oGameData.cupId) {
      var tempX = canvas.width / 2 + aMapMarkerPos[i][0];
      var tempY = canvas.height * 0.45 + aMapMarkerPos[i][1];
      userInput.addHitArea(
        "playFromMap",
        butEventHandler,
        null,
        "rect",
        {
          aRect: [tempX - 40, tempY - 40, tempX + 40, tempY + 40],
        },
        true
      );
    }
...
function initGameIntro() {
  ...
  if (!forcedMode) {
    oGameData.enemyId = countryFlags.getIdFromISO(
      aEnemyCountries[oGameData.cupId][oGameData.gameId]
    );
...
function initGame(_restart) {
  window.famobi_analytics
    .trackEvent(
      _restart
        ? window.famobi_analytics.EVENT_LEVELRESTART
        : window.famobi_analytics.EVENT_LEVELSTART,
      { levelName: "" + (oGameData.cupId * 6 + (oGameData.gameId + 1)) }
    )
...
function butEventHandler(_id, _oData) {
  ...
  switch (_id) {
    ...
    case "credits":
      playSound("hit" + Math.floor(Math.random() * 6));
      setTimeout(() => {
        window.famobi.showInterstitialAd("button:main:credits", () => {
    ...
    case "backFromCredits":
      playSound("hit" + Math.floor(Math.random() * 6));
      setTimeout(() => {
        window.famobi.showInterstitialAd("button:credits:back", () => {
    ...
    case "resetData":
      playSound("hit" + Math.floor(Math.random() * 6));
      setTimeout(() => {
        window.famobi.showInterstitialAd("button:credits:reset", () => {
          userInput.removeHitArea("backFromCredits");
          userInput.removeHitArea("resetData");
          userInput.removeHitArea("mute");
          userInput.removeHitArea("control0FromCredits");
    ...
    case "resetDataFromMap":
      playSound("hit" + Math.floor(Math.random() * 6));
      setTimeout(() => {
        window.famobi.showInterstitialAd("button:map:reset", () => {
    ...
    case "changeCountryFromStart":
      playSound("hit" + Math.floor(Math.random() * 6));
      setTimeout(() => {
        window.famobi.showInterstitialAd("button:main:country", () => {
          userInput.removeHitArea("playFromStart");
          userInput.removeHitArea("moreGames");
          userInput.removeHitArea("credits");
          userInput.removeHitArea("cupsFromStart");
    ...
    case "cupsFromStart":
      playSound("hit" + Math.floor(Math.random() * 6));
      setTimeout(() => {
        window.famobi.showInterstitialAd("button:main:cups", () => {
          userInput.removeHitArea("playFromStart");
          userInput.removeHitArea("moreGames");
          userInput.removeHitArea("credits");
          userInput.removeHitArea("cupsFromStart");
    ...
    case "playFromStart":
      ...
      setTimeout(() => {
        window.famobi.showInterstitialAd(
          firstRun ? "button:main:country" : "button:main:intro",
          () => {
            userInput.removeHitArea("playFromStart");
            userInput.removeHitArea("moreGames");
            userInput.removeHitArea("credits");
    ...
    case "countryChoice":
      ...
      setTimeout(() => {
        window.famobi.showInterstitialAd(
          firstRun ? "button:country:map" : "button:country:start",
          () => {
    ...
    case "backFromChooseCountry":
      ...
      setTimeout(() => {
        window.famobi.showInterstitialAd(
          flagPage == 1 ? "button:country:browse" : "button:country:home",
          () => {
            userInput.removeHitArea("backFromChooseCountry");
            userInput.removeHitArea("moreFromChooseCountry");
            userInput.removeHitArea("countryChoice");
    ...
    case "moreFromChooseCountry":
      playSound("hit" + Math.floor(Math.random() * 6));
      setTimeout(() => {
        window.famobi.showInterstitialAd("button:country:next", () => {
          userInput.removeHitArea("backFromChooseCountry");
          userInput.removeHitArea("moreFromChooseCountry");
          userInput.removeHitArea("countryChoice");
          if (flagPage == 0) {
    ...
    case "backFromMap":
      ...
      setTimeout(() => {
        window.famobi.showInterstitialAd(
          firstRun ? "button:map:country" : "button:map:home",
          () => {
            userInput.removeHitArea("resetDataFromMap");
            userInput.removeHitArea("backFromMap");
            userInput.removeHitArea("playFromMap");
    ...
    case "playFromMap":
      playSound("hit" + Math.floor(Math.random() * 6));
      setTimeout(() => {
        window.famobi.showInterstitialAd("button:map:start", () => {
          userInput.removeHitArea("resetDataFromMap");
          userInput.removeHitArea("backFromMap");
          userInput.removeHitArea("playFromMap");
          initGameIntro();
    ...
    case "backFromGameIntro":
      ...
      setTimeout(() => {
        window.famobi.showInterstitialAd(
          firstRun ? "button:intro:map" : "button:intro:home",
          () => {
            userInput.removeHitArea("backFromGameIntro");
            userInput.removeHitArea("playFromGameIntro");
            if (firstRun) {
    ...
    case "backFromGameComplete":
      playSound("hit" + Math.floor(Math.random() * 6));
      setTimeout(() => {
        window.famobi.showInterstitialAd("button:result:home", () => {
    ...
    case "playFromPause":
      ...
      setTimeout(() => {
        window.famobi.showInterstitialAd("button:pause:resume", () => {
          if (audioType == 1) {
            if (!muted) {
              Howler.mute(false);
              playMusic();
    ...
    case "restartFromPause":
      playSound("hit" + Math.floor(Math.random() * 6));
      setTimeout(() => {
        window.famobi.showInterstitialAd("button:pause:restart", () => {
          try {
            window.famobi_analytics.trackEvent(
    ...
    case "quitFromPause":
      playSound("hit" + Math.floor(Math.random() * 6));
      setTimeout(() => {
        window.famobi.showInterstitialAd("button:pause:home", () => {
          try {
            window.famobi_analytics.trackEvent(
              famobi_analytics.EVENT_LEVELFAIL,
              {
...
function updateScore(_player, _cause) {
  ...
  if (rallyHits <= 4 && Math.random() > 0.5) {
  ...
  if (_player == "user") {
    ...
    window.famobi_analytics.trackStats("point_scored", {
    ...
    playSound("userPoint");
    if (
      (oGameData.userScore >= max_score &&
        (max_score < 2 || oGameData.enemyScore <= oGameData.userScore - 2)) ||
      oGameData.userScore == 99
    ) {
      initGameComplete();
    }
  } else {
    ...
    if (
      (oGameData.enemyScore >= max_score &&
        (max_score < 2 || oGameData.userScore <= oGameData.enemyScore - 2)) ||
      oGameData.enemyScore == 99
    ) {
      initGameComplete();
    }
  }
...
function initGameComplete() {
  ...
  window.famobi_analytics
    ...
    .then(
      function () {
        Promise.all([
          window.famobi.showInterstitialAd("break:result"),
          window.famobi_analytics.trackEvent(
            "EVENT_CUSTOM",
            oGameData.userScore > oGameData.enemyScore
              ? {
...
function updateGameEvent() {
  ...
  if (
    ...
    (ball.height < 0 &&
      ball.tablePosY < 0.5 &&
      (ball.tablePosX < -1 || ball.tablePosX > 1))
  ) {
    ball.render();
    tableTop.render();
    enemyBat.render();
