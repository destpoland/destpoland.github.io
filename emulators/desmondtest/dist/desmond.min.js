        ...
        emuIsRunning) {
            ...
            for (p = 0; p < t.touches.length; p++) {
                ...
                if (v === stickTouchID || g == vkMap.stick && v != tpadTouchID) {
                    ...
                    v === tpadTouchID || isPointInRect(_.clientX, _.clientY, m) && !h ? (r = !0,
            ...
            vkState)
                if (vkState[h][0] != vkState[h][1]) {
                    ...
                    vkState[h][1] ? (g.classList.add("vk-touched"),
                    "menu" == h && uiSwitchTo("menu")) : (g.classList.remove("vk-touched"),
                    "stick" == h && (a = !0))
                }
            ...
            a && (vkMap.stick.style = makeVKStyle(i - s / 2, u - s / 2, s, l, vkStickPos[4])),
            stickTouchID = d,
            tpadTouchID = f
        }
    }
...
function uiSwitchTo(mode) {
    ...
    if (mode == 'player') {
        var gameplat = document.querySelector("desmond-player");
        gameplat.hidden = false
        for (var i = 0; i < 14; i++) {
            emuKeyState[i] = false
        }
        if (config.vkEnabled) {
