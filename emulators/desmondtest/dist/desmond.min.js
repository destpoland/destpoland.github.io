...
if (player) {
    ...
    const e = ["right", "left", "down", "up", "select", "start", "b", "a", "y", "x", "l", "r", "debug", "lid", "turbo"];
...
var emuKeyState = new Array(15)
const emuKeyNames = ["right", "left", "down", "up", "select", "start", "b", "a", "y", "x", "l", "r", "debug", "lid", "turbo"]
var vkMap = {}
var vkState = {}
var keyNameToKeyId = {}
...
function uiAdjustVKLayout() {
    ...
    $id('vk-dpad-1').style =  makeVKStyle(dpadY + dpadH / 3, dpadX, dpadW, dpadH / 3, fontSize) 
    $id('vk-dpad-2').style =  makeVKStyle(dpadY, dpadX + dpadW / 3, dpadW / 3, dpadH, fontSize) 
