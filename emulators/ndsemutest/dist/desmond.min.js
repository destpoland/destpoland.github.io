...
!function(e) {
    ...
    return function e(t, r, n) {
        ...
        4: [function(e, t, r) {
            ...
            var D = {
                ...
                _initStorage: function(e) {
                    ...
                    return i.all(a).then(function() {
                        ...
                        return r.db = e,
                        M(r, t._defaultConfig.version) ? E(r) : e
                    }).then(function(e) {
                        r.db = o.db = e,
                        t._dbInfo = r;
                        for (var n = 0; n < c.length; n++) {
                            var a = c[n];
                            a !== t && (a._dbInfo.db = r.db,
                            a._dbInfo.version = r.version)
                        }
                    })
                },
                _support: function() {
                ...
                setItem: function(e, t, r) {
                    ...
                    var o = new i(function(r, o) {
                        ...
                        n.ready().then(function() {
                            return a = n._dbInfo,
                            "[object Blob]" === p.call(t) ? v(a.db).then(function(e) {
                                return e ? t : (r = t,
                                new i(function(e, t) {
                        ...
                        r = e.storeName ? a.then(function(t) {
                            if (t.objectStoreNames.contains(e.storeName)) {
                                ...
                                return new i(function(t, n) {
                                    ...
                                    throw (g(e, t) || i.resolve()).catch(function() {}),
                                    t
                                })
                            }
                        }) : a.then(function(t) {
            ...
            function V(e) {
                var t, r, n, o, a, i = .75 * e.length, u = e.length, s = 0;
                "=" === e[e.length - 1] && (i--,
                "=" === e[e.length - 2] && i--);
            ...
            var J = {
                serialize: function(e, t) {
                    ...
                    e && ("[object ArrayBuffer]" === r || e.buffer && "[object ArrayBuffer]" === K.call(e.buffer))) {
                        ...
                        o += x) : (n = e.buffer,
                        "[object Int8Array]" === r ? o += O : "[object Uint8Array]" === r ? o += B : "[object Uint8ClampedArray]" === r ? o += L : "[object Int16Array]" === r ? o += j : "[object Uint16Array]" === r ? o += z : "[object Int32Array]" === r ? o += U : "[object Uint32Array]" === r ? o += Y : "[object Float32Array]" === r ? o += W : "[object Float64Array]" === r ? o += q : t(new Error("Failed to get type for BinaryArray"))),
                        t(o + X(n))
                ...
                deserialize: function(e) {
                    if (e.substring(0, H) !== N)
                        return JSON.parse(e);
                    var t, r = e.substring(G), n = e.substring(H, G);
                    if (n === C && I.test(r)) {
                        var o = r.match(I);
                        t = o[1],
                            ...
                            o.db.transaction(function(r) {
                                $(r, o, "SELECT * FROM " + o.storeName, [], function(r, n) {
                                    for (var a = n.rows, i = a.length, u = 0; u < i; u++) {
                                        var s = a.item(u)
                                          , l = s.value;
                                        if (l && (l = o.serializer.deserialize(l)),
            ...
            var re = {
                ...
                _initStorage: function(e) {
                    ...
                    if (e)
                        for (var r in e)
                            t[r] = e[r];
                    return t.keyPrefix = ee(e, this._defaultConfig),
                    te() ? (this._dbInfo = t,
                    t.serializer = J,
                    i.resolve()) : i.reject()
                },
                      ...
                      , n = r.ready().then(function() {
                        for (var t = r._dbInfo, n = t.keyPrefix, o = n.length, a = localStorage.length, i = 1, u = 0; u < a; u++) {
                            ...
                            if (0 === s.indexOf(n)) {
                                ...
                                if (l && (l = t.serializer.deserialize(l)),
                        ...
                        return new i(function(o, a) {
                            ...
                            i.serializer.serialize(t, function(t, n) {
                                if (n)
                                    ...
                                    try {
                                        localStorage.setItem(i.keyPrefix + e, t),
                                        o(r)
                                    } catch (e) {
            ...
            var pe = new (function() {
                ...
                e.prototype.defineDriver = function(e, t, r) {
                    var n = new i(function(t, r) {
                        try {
                                ...
                                for (var t = function(e) {
                                    return function() {
                                        var t = new Error("Method " + e + " is not implemented by the current driver")
                                          , r = i.reject(t);
                                        return u(r, arguments[arguments.length - 1]),
                                        r
                                    }
                            ...
                            var d = function(r) {
                                ae[n] && console.info("Redefining LocalForage driver: " + n),
                                ae[n] = e,
                                ie[n] = r,
                                t()
                            };
                ...
                e.prototype.setDriver = function(e, t, r) {
                    ...
                    return this._driverSet = l.then(function() {
                            ...
                            n._initDriver = function(e) {
                                return function() {
                                    ...
                                    return function r() {
                                        ...
                                        return n._driverSet = i.reject(s),
                                        n._driverSet
                                    }()
                                }
                            }(o)
                        ...
                        return n._driverSet = i.reject(e),
                        n._driverSet
                    }),
...
if (player) {
    ...
    var getFileBlob = function(e, t) {
      ...
      , blobToFile = function(e, t) {
        return e.lastModifiedDate = new Date(timestamp * 1000),
        e.name = t,
        e
    }
        ...
        player.enableMicrophone = function() {
            ...
            navigator.mediaDevices.getUserMedia({
                ...
                a.onaudioprocess = function(r) {
                    ...
                    for (var u = 0; u < 1; u++)
                        for (n = r.outputBuffer.getChannelData(u),
                        a = 0; a < 2048; a++)
                            n[a] = 0
                }
                ,
    ...
    var emuKeyState = new Array(16);
    const e = ["right", "left", "down", "up", "select", "start", "b", "a", "y", "x", "l", "r", "debug", "lid", "turbo", "reset"];
    ...
    var audioContext, audioBuffer, audioWorkletNode, fbSize, emuGameID = "unknown", emuIsRunning = !1, emuIsGameLoaded = !1, fileInput = $id("rom"), romSize = 0, FB = [0, 0], screenCanvas = [shadow.getElementById("top"), shadow.getElementById("bottom")], ctx2d = screenCanvas.map(e=>e.getContext("2d", {
        alpha: !1
    })), tmpAudioBuffer = new Int16Array(32768), frameCount = 0, touched = 0, touchX = 0, touchY = 0, prevSaveFlag = 0, lastTwoFrameTime = 10;
    ...
    function emuRunFrame() {
        ...
        for (var e = 0, t = 0; t < 14; t++)
            emuKeyState[t] && (e |= 1 << t);
        if (emuKeyState[11] && (console.log("mic"),
        e |= 16384),
        ...
        for (var k in emuKeyState) {
            if (emuKeyState[k][1] != emuKeyState[k][2]) {
                if (emuKeyState[k][1]) {
    ...
    resetModeButton = emuKeyState[15]
    if (resetModeButton) {
        emuKeyState[10] = 1
        emuKeyState[11] = 1
        emuKeyState[4] = 1
        ...
        fastForwardMode = emuKeyState[14]
            if (fastForwardMode) {
                emuUseTimer33 = true
            }
            else if (fastForwardMode == false) {
                emuUseTimer33 = false
            }
    ...
    async function tryLoadROM(e) {
        if (e && !(e.size < 1024)) {
            ...
            gameID = decoder.decode(romData.subarray(0x0, 0xC)).trim();
            console.log("Detected gameID:", gameID);
            ...
            if (o && Module.HEAPU8.set(o, Module._savGetPointer(o.length)),
            Module._savUpdateChangeFlag(),
            1 == Module._loadROM(romSize)) {
                ptrFrontBuffer = Module._getSymbol(5);
                var a = Module._getSymbol(4);
                for (r = 0; r < 2; r++)
                    FB[r] = new ImageData(new Uint8ClampedArray(Module.HEAPU8.buffer).subarray(a + 196608 * r, a + 196608 * (r + 1)),256,192);
                var i = Module._getSymbol(6);
                audioBuffer = new Int16Array(Module.HEAPU8.buffer).subarray(i / 2, i / 2 + 32768),
                console.log("Start!!!"),
                emuIsGameLoaded = !0,
                emuIsRunning = !0,
    ...
    function emuLoop() {
        if (window.requestAnimationFrame(emuLoop),
        emuIsRunning) {
    ...
    function processGamepadInput() {
        if (!(currentConnectedGamepad < 0)) {
            ...
            if (!e)
                return showMsg("Gamepad disconnected."),
                void (currentConnectedGamepad = -1);
            ...
            e.axes[0] < -.5 && (emuKeyState[keyNameToKeyId.left] = !0),
            e.axes[0] > .5 && (emuKeyState[keyNameToKeyId.right] = !0),
            e.axes[1] < -.5 && (emuKeyState[keyNameToKeyId.up] = !0),
            e.axes[1] > .5 && (emuKeyState[keyNameToKeyId.down] = !0)
        }
    }
    function whatsNew() {
...
var read_, readAsync, readBinary, setWindowTitle, fs, nodePath, requireNodeFS, Module = void 0 !== Module ? Module : {}, moduleOverrides = Object.assign({}, Module), arguments_ = [], thisProgram = "./this.program", quit_ = (e,t)=>{
    throw t
}
...
requireNodeFS = (()=>{
    nodePath || (fs = require("fs"),
    nodePath = require("path"))
}
),
read_ = function(e, t) {
    return requireNodeFS(),
...
var wasmBinary, tempRet0 = 0, setTempRet0 = e=>{
    tempRet0 = e
}
;
...
function allocateUTF8(e) {
    var t = lengthBytesUTF8(e) + 1
      , r = _malloc(t);
    return r && stringToUTF8Array(e, HEAP8, r, t),
    r
}
...
var wasmTable, INITIAL_MEMORY = Module.INITIAL_MEMORY || 536870912, __ATPRERUN__ = [], __ATINIT__ = [], __ATMAIN__ = [], __ATPOSTRUN__ = [], runtimeInitialized = !1, runtimeExited = !1, runtimeKeepaliveCounter = 0;
...
function getWasmTableEntry(e) {
    ...
    return t || (e >= wasmTableMirror.length && (wasmTableMirror.length = e + 1),
...
function ___cxa_throw(e, t, r) {
    throw new ExceptionInfo(e).init(t, r),
    exceptionLast = e,
...
var TTY = {
    ...
    default_tty_ops: {
        ...
        put_char: function(e, t) {
            null === t || 10 === t ? (out(UTF8ArrayToString(e.output, 0)),
    ...
    default_tty1_ops: {
        put_char: function(e, t) {
            null === t || 10 === t ? (err(UTF8ArrayToString(e.output, 0)),
            e.output = []) : 0 != t && e.output.push(t)
        },
        flush: function(e) {
    ...
    stream_ops: {
        ...
        write: function(e, t, r, n, o, a) {
            ...
            t.subarray && (!i.contents || i.contents.subarray)) {
                if (a)
                    return i.contents = t.subarray(r, r + n),
                    i.usedBytes = n,
                    n;
                if (0 === i.usedBytes && 0 === o)
                    return i.contents = t.slice(r, r + n),
                    i.usedBytes = n,
                    n;
                if (o + n <= i.usedBytes)
                    return i.contents.set(t.subarray(r, r + n), o),
                    n
            }
        ...
        llseek: function(e, t, r) {
            var n = t;
            if (1 === r ? n += e.position : 2 === r && FS.isFile(e.node.mode) && (n += e.node.usedBytes),
            n < 0)
                throw new FS.ErrnoError(28);
            return n
        },
        ...
        mmap: function(e, t, r, n, o, a) {
            ...
            if (2 & a || s.buffer !== buffer) {
                if ((n > 0 || n + r < s.length) && (s = s.subarray ? s.subarray(n, n + r) : Array.prototype.slice.call(s, n, n + r)),
                u = !0,
                !(i = mmapAlloc(r)))
...
var FS = {
    ...
    lookupPath: (e,t={})=>{
        ...
        for (var r = PATH.normalizeArray(e.split("/").filter(e=>!!e), !1), n = FS.root, o = "/", a = 0; a < r.length; a++) {
            ...
            if (i && t.parent)
                break;
            if (n = FS.lookupNode(n, r[a]),
            o = PATH.join2(o, r[a]),
            FS.isMountpoint(n) && (!i || i && t.follow_mount) && (n = n.mounted.root),
            !i || t.follow)
                for (var u = 0; FS.isLink(n.mode); ) {
                    var s = FS.readlink(o);
                    if (o = PATH_FS.resolve(PATH.dirname(o), s),
                    n = FS.lookupPath(o, {
    ...
    ,
    create: (e,t)=>(t = void 0 !== t ? t : 438,
    t &= 4095,
    t |= 32768,
    FS.mknod(e, t, 0)),
    mkdir: (e,t)=>(t = void 0 !== t ? t : 511,
    t &= 1023,
    t |= 16384,
    FS.mknod(e, t, 0)),
    mkdirTree: (e,t)=>{
    ...
    ,
    rename: (e,t)=>{
        var r, n, o = PATH.dirname(e), a = PATH.dirname(t), i = PATH.basename(e), u = PATH.basename(t);
        ...
        var s, l = FS.lookupNode(r, i), c = PATH_FS.relative(e, a);
        if ("." !== c.charAt(0))
            throw new FS.ErrnoError(28);
    ...
    open: (e,t,r,n,o)=>{
        ...
        var a;
        if (r = void 0 === r ? 438 : r,
        r = 64 & (t = "string" == typeof t ? FS.modeStringToFlags(t) : t) ? 4095 & r | 32768 : 0,
        "object" == typeof e)
            a = e;
        else {
            e = PATH.normalize(e);
        ...
        if (!a)
            throw new FS.ErrnoError(44);
        if (FS.isChrdev(a.mode) && (t &= -513),
        65536 & t && !FS.isDir(a.mode))
            throw new FS.ErrnoError(54);
        if (!i) {
    ...
    readFile: (e,t={})=>{
        ...
        "utf8" === t.encoding ? r = UTF8ArrayToString(a, 0) : "binary" === t.encoding && (r = a),
        FS.close(n),
        r
    }
    ,
    ...
    createLazyFile: (e,t,r,n,o)=>{
        ...
        a.prototype.cacheLength = function() {
            ...
            var t, n = Number(e.getResponseHeader("Content-length")), o = (t = e.getResponseHeader("Accept-Ranges")) && "bytes" === t, a = (t = e.getResponseHeader("Content-Encoding")) && "gzip" === t, i = 1048576;
            o || (i = n);
            var u = this;
            u.setDataGetter(e=>{
                var t = e * i
                  , o = (e + 1) * i - 1;
                if (o = Math.min(o, n - 1),
                void 0 === u.chunks[e] && (u.chunks[e] = ((e,t)=>{
                    if (e > t)
...
function _tzset_impl(e, t, r) {
    ...
    HEAP32[e >> 2] = 60 * s,
    HEAP32[t >> 2] = Number(i != u);
    var c = l(o)
      , d = l(a)
      , f = allocateUTF8(c)
      , m = allocateUTF8(d);
    u < i ? (HEAP32[r >> 2] = f,
    HEAP32[r + 4 >> 2] = m) : (HEAP32[r >> 2] = m,
    HEAP32[r + 4 >> 2] = f)
}
function __tzset_js(e, t, r) {
    __tzset_js.called || (__tzset_js.called = !0,
    _tzset_impl(e, t, r))
}
function _abort() {
    abort("")
...
function readAsmConstArgs(e, t) {
    var r;
    for (readAsmConstArgsArray.length = 0,
    t >>= 2; r = HEAPU8[e++]; ) {
        var n = r < 105;
        n && 1 & t && t++,
...
function _fd_seek(e, t, r, n, o) {
    try {
        var a = SYSCALLS.getStreamFromFD(e)
          , i = 4294967296 * r + (t >>> 0);
        return i <= -9007199254740992 || i >= 9007199254740992 ? -61 : (FS.llseek(a, i, n),
...
// Your updateDateTime function
function updateDateTime() {
    if (!isNaN(timestamp) && timestamp !== 0) {
        timestamp++
        var date = new Date(timestamp * 1000); // Multiply by 1000 to convert seconds to milliseconds
        
        // Convert timestamp to individual date components
        var seconds = date.getSeconds();
        var minutes = date.getMinutes();
        var hours = date.getHours();
        var day = date.getDate();
        var month = date.getMonth();
        var year = date.getFullYear() - 1900; // Subtract 1900 to convert to years since 1900
        
        // Assuming HEAP32 is a typed array
        HEAP32[0 >> 2] = seconds;
        HEAP32[4 >> 2] = minutes;
        HEAP32[8 >> 2] = hours;
        HEAP32[12 >> 2] = day;
        ...
        document.getElementById("currentDateTime").textContent = date.toLocaleString();
    } else {
        document.getElementById("currentDateTime").textContent = "Invalid Time";
    }
}
...
// Your changeDateTime function
function changeDateTime() {
    var newDateTime = document.getElementById("newDateTimeInput").value;
    if (newDateTime) {
        var newTimestamp = Date.parse(newDateTime) / 1000; // Convert to seconds
        if (!isNaN(newTimestamp)) {
            timestamp = newTimestamp; // Update the global timestamp variable
            updateDateTime(); // Call updateDateTime to reflect the changes
            closeModal(); // Close the modal after updating
        } else {
            alert("Invalid date and time format. Please select a valid date and time.");
        }
    }
}
...
function __localtime_js(time, tmPtr) {
    ...
    else var date = new Date(timestamp * 1e3);
...
function _strftime(e, t, r, n) {
    ...
    var _ = {
        ...
        "%V": function(e) {
            var t, r = new Date(e.tm_year + 1900,0,4), n = new Date(e.tm_year + 1901,0,4), o = p(r), a = p(n), i = __addDays(new Date(e.tm_year + 1900,0,1), e.tm_yday);
            return m(i, o) < 0 ? "53" : m(a, i) <= 0 ? "01" : (t = o.getFullYear() < e.tm_year + 1900 ? e.tm_yday + 32 - o.getDate() : e.tm_yday + 1 - o.getDate(),
            f(Math.ceil(t / 7), 2))
        },
        "%w": function(e) {
            return e.tm_wday
...
function _time(e) {
    ...
    return e && (HEAP32[e >> 2] = t),
    t
}
Module.__MONTH_DAYS_REGULAR = __MONTH_DAYS_REGULAR,
Module.__addDays = __localtime_js,
Module._strftime = __localtime_js,
Module._strftime_l = __localtime_js,
Module._time = __localtime_js;
...
function emuRunFrame3() {
    ...
    if ($id('cfg-turbo').checked) {
        for (var i = 0; i < 2; i++) {
            Module._runFrame(0, keyMask, touched, touchX, touchY)
            emuRunAudio()
            
        }
    } else if ($id('cfg-turbo2').checked) {
        for (var i = 0; i < 4; i++) {
        Module._runFrame(0, keyMask, touched, touchX, touchY)
        emuRunAudio()
        }
        ...
        Module._runFrame(-290, keyMask, touched, touchX, touchY)
    }
...
function emuTimer15() {
    if (emuIsRunning && emuUseTimer15) {
        emuRunFrame3()
    }
}
setInterval(emuTimer15, 33)


var emuKeyState = new Array(16)
const emuKeyNames = ["right", "left", "down", "up", "select", "start", "b", "a", "y", "x", "l", "r", "debug", "lid", "turbo", "reset"]
var vkMap = {}
var vkState = {}
var keyNameToKeyId = {}
...
function uiAdjustVKLayout() {
    ...
    var offTop =  Math.min(window.innerHeight - Math.ceil(baseSize * 3.62))
    var offLeft = 0
    ...
    vkMap['l'].style = makeVKStyle((offTop - offTop + 50), 0, vkw, vkh, fontSize)
    vkMap['reset'].style =  config.ResetButton ? makeVKStyle((offTop - offTop + 250), window.innerWidth - vkw, vkw, vkh, fontSize): 'display:none;'
    vkMap['turbo'].style = makeVKStyle((offTop - offTop + 250), 0, vkw, vkh, fontSize)
    vkMap['r'].style = makeVKStyle((offTop - offTop + 50), window.innerWidth - vkw, vkw, vkh, fontSize)
    vkw = baseSize * 0.4
    vkh = baseSize * 0.4
    $id('vk-menu').style = makeVKStyle((offTop - offTop ), window.innerWidth / 1.012 - vkw / 2, vkw, vkh, fontSize)
    


    offTop += baseSize * 0.32
    vkw = baseSize
    vkh = baseSize
    offLeft = window.innerWidth - abxyWidth - 30
    ...
    vkMap['select'].style = makeVKStyle(offTop + abxyHeight - vkh, window.innerWidth / 2 - vkw * 1.5, vkw + 25, vkh, fontSize)
    vkMap['start'].style = makeVKStyle(offTop + abxyHeight - vkh, window.innerWidth / 2 + vkw * 0.5, vkw + 25, vkh, fontSize)
}
...
function setScreenPos2(c, left, top, w, h) {
    var sty = 'left:' + left + '%;top:' + top + "px;width:" + w + "px;height:" + h + "px;"
    if (optScaleMode == 0) {
        sty += 'image-rendering:pixelated;'
    }
    c.style = sty
...
function uiUpdateLayout() {
    ...
    if ((!isLandscape) || (config.lsLayout == 0)) {
        ...
        GamePlayer = player.shadowRoot.getElementById("desplayer").children
        var GameTop = GamePlayer.top
        var GameBottom = GamePlayer.bottom

        GameBottom.style="left: 355px;top: 50px;width: 128px;height: 96px;position: fixed;"
        GameTop.style="left: -40px; top: -20px; width: 384px; height: 288px; position: relative;"

    }
    if ((!isLandscape) || (config.lsLayout == 1)) {
        // Top-bottom
        var maxWidth = window.innerWidth / 2
        var maxHeight = window.innerHeight / 2
        var sz = maxScreenSize(maxWidth, maxHeight); var w = sz[0]; var h = sz[1];
        ...
        GameTop.style="left: 355px;top: 50px;width: 128px;height: 96px;position: fixed;"
        GameBottom.style="left: -40px; top: -20px; width: 384px; height: 288px; position: relative;"

    }
    else if((!isLandscape) || (config.lsLayout == 2)) {
        // Top-bottom
    ...
    else if((!isLandscape) || (config.lsLayout == 3)) {
        // Top-bottom
        var maxWidth = window.innerWidth / 2
        var maxHeight = window.innerHeight / 2
        var sz = maxScreenSize(maxWidth, maxHeight); var w = sz[0]; var h = sz[1];
        ...
        GameTop.style="left: 355px;top: 0px;width: 384px;height: 288px;position: fixed;"
        GameBottom.style="left: -80px; top: 0px; width: 384px; height: 288px; position: relative;"
    }
    uiAdjustVKLayout()
}
...
function loadConfig() {
    ...
    $id('cfg-turbo2').checked = config.turbo2
    $id('cfg-scale-mode').value = config.scaleMode
    $id('cfg-lang').value = config.fwLang
    $id('cfg-swap-abxy').checked = config.swapABXY
    $id('toggleDrag').checked = config.TogDrag 
    $id('newDateTimeInput').checked = config.DateTime 
    $id('cfg-reset').checked = config.ResetButton 
    $id('cfg-opt').checked = (localStorage['simd'] == '1')
    afterConfigUpdated()
    optScaleMode = $id('cfg-scale-mode').value
}
loadConfig()
...
function uiSaveConfig() {
    ...
    config.turbo2 = !!($id('cfg-turbo2').checked)
    ...
    config.TogDrag = !!($id('toggleDrag').checked)
    config.DateTime = !!($id('newDateTimeInput').checked)
    config.ResetButton = !!($id('cfg-reset').checked)
...
function uiSwitchTo(mode) {
    ...
    if (mode == 'player') {
        ...
        if (config.vkEnabled) {
            ...
            console.log('sigma')
            console.log($id('cfg-turbo').checked)      
        }
